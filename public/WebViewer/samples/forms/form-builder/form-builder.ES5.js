!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? p(n, S) : f ? p(n, 0) : void 0; S > x; x++)
          if ((h || x in m) && ((d = b((y = m[x]), x, g)), t))
            if (r) w[x] = d;
            else if (d)
              switch (t) {
                case 3:
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = d(c.length), o = Ft(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
        ...
        Lt = function() {
          return vt.apply(Tt ? ht.call(Ot(this)) : Ot(this), arguments);
        },
        Rt = {
          ...
          filter: function(t) {
            return Pt(this, $(Ot(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Ct = function(t, n) {
          return Pt(this, ht.call(Ot(this), t, n));
        },
        kt = function(t) {
          Ot(this);
        ...
        Wt = function(t, n) {
          return w(t) && t[St] && 'symbol' != e(n) && n in t && String(+n) == String(n);
        },
        Ut = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? h(2, t[n]) : G(t, n);
        },
        Bt = function(t, n, r) {
          return !(Wt(t, (n = b(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? V(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((B.f = Ut), (U.f = Bt)),
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: Ct, set: kt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        jt(Vt, 'buffer', 'b'),
        jt(Vt, 'byteOffset', 'o'),
        jt(Vt, 'byteLength', 'l'),
        jt(Vt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof q || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                    if (y % n) throw Y('Wrong length!');
                    if ((u = y - h) < 0) throw Y('Wrong length!');
                  } else if ((u = d(o) * n) + h > y) throw Y('Wrong length!');
                  c = u / n;
                } else (c = g(r)), (i = new q((u = c * n)));
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new K(i) }); s < c; ) A(t, s++);
              })),
              (_ = v.prototype = E(Vt)),
              p(_, 'constructor', v))
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, a),
                  w(r)
                    ? r instanceof q || 'ArrayBuffer' == (i = x(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Et(e, n), o)
                        : void 0 !== e
                        ? new y(r, Et(e, n))
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        F = O || x(y),
        P = y ? (_ ? x('entries') : F) : void 0,
        M = ('Array' == n && E.entries) || O;
      if (
        (M && (S = s(M.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          O &&
          'values' !== O.name &&
          ((A = !0),
        ...
        if (((m = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: P }), g)) for (b in m) b in E || i(E, b, m[b]);
        else o(o.P + o.F * (h || A), n, m);
      return m;
    };
  },
  function(t, n, r) {
    ...
    function N(t, n, r) {
      ...
      for (
        (t = A(t)) != t || t === w
          ...
          : ((e = O(F(t) / P)),
            t * (i = E(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + a >= 1 ? s / i : s * E(2, 1 - a)) * i >= 2 && (e++, (i /= 2)),
            e + a >= f ? ((o = 0), (e = f)) : e + a >= 1 ? ((o = (t * i - 1) * E(2, n)), (e += a)) : ((o = t * E(2, a - 1) * E(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
      ...
      r(2)(function() {
        ...
        ? function(t, n) {
            for (var r = c(t), a = arguments.length, s = 1, l = i.f, h = u.f; a > s; )
              for (var p, v = f(arguments[s++]), y = l ? o(v).concat(l(v)) : o(v), d = y.length, g = 0; d > g; ) (p = y[g++]), (e && !h.call(v, p)) || (r[p] = v[p]);
            return r;
          }
        : a;
  },
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (P || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== O.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
      ...
      L = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                P ? A.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = P || R(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      C = function(t) {
        g.call(f, function() {
          var n;
          P ? A.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      k = function(t) {
        var n = this;
    ...
    I ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = a(D, t, 1)), (this.reject = a(k, t, 1));
      }),
      (b.f = j = function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      X =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(G, n);
              e && delete G[n], N(t, n, r), e && t !== G && N(G, n, e);
            }
          : N,
      q = function(t) {
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, k) && t[k][n] && (t[k][n] = !1), (r = E(r, { enumerable: A(0, !1) }))) : (i(t, k) || N(t, k, A(1, {})), (t[k][n] = !0)), X(t, n, r)) : N(t, n, r)
        );
      },
      $ = function(t, n) {
        b(t);
      ...
      Q = function(t) {
        ...
        return !(this === G && i(B, t) && !i(V, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, k) && this[k][t])) || n);
      },
      Z = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(B, n) || i(V, n))) {
          var r = I(t, n);
          return !r || !i(B, n) || (i(t, k) && t[k][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == k || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = T(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(G, n)) || o.push(B[n]);
        return o;
      };
    Y ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(V, r), i(this, k) && i(this[k], t) && (this[k][t] = !1), X(this, t, A(1, r));
            };
          return u && H && X(G, t, { configurable: !0, set: n }), q(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = Q),
      (P.f = nt),
      u && !r(30) && f(G, 'propertyIsEnumerable', Q, !0),
      (y.f = function(t) {
        return q(v(t));
      })),
      c(c.G + c.W + c.F * !Y, { Symbol: L });
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      L.prototype[D] || r(14)(L.prototype, D, L.prototype.valueOf),
      h(L, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            m = s(h);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && c(m)))) for (r = new p((n = f(h.length))); n > g; g++) a(r, g, d ? y(h[g], g) : h[g]);
          else for (l = m.call(h), r = new p(); !(o = l.next()).done; g++) a(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var A = String(b[0]), E = a(s(u(b.index), h.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (S = b[F]) ? S : String(S));
            var P = b.groups;
            if (p) {
              var M = [A].concat(O, E, h);
              void 0 !== P && M.push(P);
              var j = String(n.apply(void 0, M));
            } else j = y(A, h, E, O, P, n);
            E >= w && ((x += h.slice(w, E) + j), (w = E + A.length));
          }
          return x + h.slice(w);
        },
      ];
          ...
          'c' == 'abbc'.split(/(b)*/)[1] || 4 != 'test'.split(/(?:)/, -1)[p] || 2 != 'ab'.split(/(?:ab)*/)[p] || 4 != '.'.split(/(.?)(.?)/)[p] || '.'.split(/()()/)[p] > 1 || ''.split(/.?/)[p]
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = a.call(y, o)) && !((u = y.lastIndex) > l && (f.push(o.slice(l, i.index)), i[p] > 1 && i.index < o[p] && h.apply(f, i.slice(1)), (c = i[0][p]), (l = u), f[p] >= v));
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                A = f(m, v ? h : h.slice(x));
              if (null === A || (_ = l(c(m.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
                if ((w.push(h.slice(S, x)), w.length === b)) return w;
                for (var E = 1; E <= A.length - 1; E++) if ((w.push(A[E]), w.length === b)) return w;
                x = S = _;
              }
            }
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      b = (t.exports = r(58)('WeakMap', g, m, a, !0, !0));
    h &&
      p &&
      (f((e = a.getConstructor(g, 'WeakMap')).prototype, m),
      (c.NEED = !0),
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, g), (f[g] = h), m)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
        ...
        return (
          ...
          (_.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: A(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), s;
            },
          }),
          t
        );
    ...
    var e = r(85),
      ...
      f = function t(n, r, f) {
        var a,
          ...
          m = p ? o : o[r] || (o[r] = {}),
          b = m.prototype,
          S = p ? e : v ? e[r] : (e[r] || {}).prototype;
        for (a in (p && (f = r), f))
          ((s = !h && S && void 0 !== S[a]) && c(m, a)) ||
            ((l = s ? S[a] : f[a]),
            (m[a] =
              p && 'function' != typeof S[a]
                ? f[a]
                : d && s
                ? i(l, e)
                : g && S[a] == l
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: '../../full-apis/TestFiles/contract.pdf' }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = {},
        r = t.docViewer,
        e = t.Annotations,
        ...
        u = e.WidgetFlags,
        c = o.getFieldManager();
      (i.convertAnnotToFormField = function() {
        var t = o.getAnnotationsList(),
          r = [],
          i = [];
        return (
          t.forEach(function(t, n) {
            var f, a;
            if ('' !== t.getCustomData('type')) {
              var s = new u();
              if ((t.getCustomData('flag').readOnly && s.set(u.READ_ONLY, !0), t.getCustomData('flag').multiline && s.set(u.MULTILINE, !0), r.push(t), 'TEXT' === t.getCustomData('type')))
                (a = new e.Forms.Field(t.getContents() + Date.now() + n, { type: 'Tx', value: t.getCustomData('value'), flags: s })), (f = new e.TextWidgetAnnotation(a));
              else if ('SIGNATURE' === t.getCustomData('type'))
                (a = new e.Forms.Field(t.getContents() + Date.now() + n, { type: 'Sig', flags: s })),
                  (f = new e.SignatureWidgetAnnotation(a, {
                    appearance: '_DEFAULT',
                    appearances: {
                      _DEFAULT: {
                        Normal: {
                ...
                if ('CHECK' !== t.getCustomData('type')) return void o.deleteAnnotation(t, !1, !0);
                s.set(u.EDIT, !0);
                var l = new e.Font({ name: 'Helvetica' });
                (a = new e.Forms.Field(t.getContents() + Date.now() + n, { type: 'Btn', value: 'Off', flags: s, font: l })),
                  (f = new e.CheckButtonWidgetAnnotation(a, { appearance: 'Off', appearances: { Off: {}, Yes: {} } }));
              }
              (f.PageNumber = t.getPageNumber()),
                (f.X = t.getX()),
                (f.Y = t.getY()),
                (f.rotation = t.Rotation),
                0 === t.Rotation || 180 === t.Rotation ? ((f.Width = t.getWidth()), (f.Height = t.getHeight())) : ((f.Width = t.getHeight()), (f.Height = t.getWidth())),
                (e.WidgetAnnotation.getCustomStyles = function(t) {
                  return t instanceof e.TextWidgetAnnotation
                    ? { 'background-color': '#a5c7ff', color: 'white', 'font-size': '20px' }
                    : t instanceof e.SignatureWidgetAnnotation
                    ? { border: '1px solid #a5c7ff' }
                    : void 0;
                }),
                e.WidgetAnnotation.getCustomStyles(f),
                o.addAnnotation(f),
                c.addField(a),
                i.push(f);
            }
          }),
          o.deleteAnnotations(r, null, !0),
          o.drawAnnotationsFromList(i).then(function() {
            n = {};
          })
        );
      }),
        (i.addFormFieldAnnot = function(t, i, u, c) {
          var f = r.getZoom(),
            a = r.getDocument(),
            s = r.getDisplayModeManager().getDisplayMode(),
            l = s.getSelectedPages(n, n);
          if (!n.x || null != l.first) {
            var h = null !== l.first ? l.first : r.getCurrentPage(),
              p = a.getPageInfo(h),
              v = s.windowToPage(n, h),
              y = new e.FreeTextAnnotation();
            y.PageNumber = h;
            var d = 90 * r.getCompleteRotation(h);
            (y.Rotation = d),
              'CHECK' === t ? ((y.Width = 25 / f), (y.Height = 25 / f)) : 270 === d || 90 === d ? ((y.Width = 50 / f), (y.Height = 250 / f)) : ((y.Width = 250 / f), (y.Height = 50 / f)),
              (y.X = (v.x || p.width / 2) - y.Width / 2),
              (y.Y = (v.y || p.height / 2) - y.Height / 2),
              y.setPadding(new e.Rect(0, 0, 0, 0)),
              y.setCustomData('type', t),
              y.setCustomData('value', u),
              y.setCustomData('flag', c),
              y.setContents(''.concat(i, '_').concat(t)),
              (y.FontSize = ''.concat(10 / f, 'px')),
              (y.FillColor = new e.Color(211, 211, 211, 0.5)),
              (y.TextColor = new e.Color(0, 165, 228)),
              (y.StrokeThickness = 1),
              (y.StrokeColor = new e.Color(0, 165, 228)),
              (y.TextAlign = 'center'),
              (y.Author = o.getCurrentUser()),
              o.deselectAllAnnotations(),
              o.addAnnotation(y, !0),
              o.redrawAnnotation(y),
              o.selectAnnotation(y),
              (n = {});
          }
        }),
        (i.setDropPoint = function(t) {
          n = { x: t.x, y: t.y };
        });
    });
  },
