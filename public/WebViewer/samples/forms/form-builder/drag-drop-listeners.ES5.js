!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        jt = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = d(c.length), o = Pt(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Tt = function() {
        ...
        Wt = function(t, n) {
          return Bt(t, (n = b(n, !0))) ? p(2, t[n]) : V(t, n);
        },
        Gt = function(t, n, r) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? It(v, r) : jt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: M }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== F.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), K(t, n, r)) : T(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(G, t) && !i(U, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(G, n) || i(U, n))) {
          var r = j(t, n);
          return !r || !i(G, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = N(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(V, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), K(this, t, E(1, r));
            };
          return u && q && K(V, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), p.length), 0), F = [], P = 1; P < b.length; P++) F.push(void 0 === (x = b[P]) ? x : String(x));
            var M = b.groups;
            if (h) {
              var I = [E].concat(F, O, p);
              void 0 !== M && I.push(M);
              var A = String(n.apply(void 0, I));
            } else A = y(E, p, O, F, M, n);
            O >= w && ((S += p.slice(w, O) + A), (w = O + E.length));
          }
          return S + p.slice(w);
        },
      ];
  ...
  function(t, n) {
    var r,
      e = document.getElementById('viewer'),
      o = function() {
        var t = document.getElementById('name').value.replace(' ', '_'),
          n = document.getElementById('value').value,
          e = document.getElementById('fieldType').value,
          o = { readOnly: document.getElementById('readOnly').checked, multiline: document.getElementById('multiline').checked };
        (t += Date.now()),
          (document.getElementById('name').value = ''),
          (document.getElementById('value').value = ''),
          (document.getElementById('readOnly').checked = !1),
          'sign' === e && '' !== t
            ? r.addFormFieldAnnot('SIGNATURE', t, '', o)
            : 'text' === e && '' !== t
            ? r.addFormFieldAnnot('TEXT', t, n, o)
            : 'check' === e && '' !== t && r.addFormFieldAnnot('CHECK', t, '', o);
      },
      i = function() {
        var t = document.getElementById('fieldType').value,
          n = document.getElementById('multiline');
        'text' !== t ? ((n.disabled = !0), (n.checked = !1)) : (n.disabled = !1);
      };
    e.addEventListener('ready', function() {
      (r = e.querySelector('iframe').contentWindow).document.body.addEventListener('dragover', function(t) {
        return t.preventDefault(), !1;
      }),
        r.document.body.addEventListener('drop', function(t) {
          var n = r.docViewer.getScrollViewElement(),
            e = n.scrollLeft || 0,
            o = n.scrollTop || 0;
          return r.setDropPoint({ x: t.pageX + e, y: t.pageY + o }), t.preventDefault(), !1;
        });
    });
    var u = document.getElementById('Add');
    u.addEventListener('click', o),
      u.addEventListener('dragstart', function(t) {
        t.target.style.opacity = 0.5;
        var n = t.target.cloneNode(!1);
        n.id = 'form-build-drag-image-copy';
        var r = 'check' === document.getElementById('fieldType').value;
        (n.style.width = r ? '50px' : '250px'),
          (n.style.height = '50px'),
          (n.style.borderRadius = 0),
          (n.style.backgroundColor = 'rgba(211,211,211, 0.5)'),
          (n.style.border = '1px solid rgba(0,165,228)'),
          (n.style.padding = 0),
          (n.style.position = 'absolute'),
          (n.style.top = '-500px'),
          (n.style.left = '-500px'),
          document.body.appendChild(n),
          t.dataTransfer.setDragImage(n, r ? 25 : 125, 25),
          t.dataTransfer.setData('text', '');
      }),
      u.addEventListener('dragend', function(t) {
        o(), (t.target.style.opacity = 1), document.body.removeChild(document.getElementById('form-build-drag-image-copy')), t.preventDefault();
      }),
      document.getElementById('Apply').addEventListener('click', function() {
        r.convertAnnotToFormField();
      }),
