                                  ...
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      (u = p.getViewerCoordinates(n, r, e)),
                                        ...
                                        l.setRect(new f.Rect(u.x, Math.min(u.y, a.y), a.x, Math.max(u.y, a.y))),
                                        s.addAnnotation(l),
                                        c.push(l);
                                    case 7:
                                    case 'end':
                                  ...
                                  switch ((t.prev = t.next)) {
                                    case 0:
                                      (o = p.getViewerCoordinates(n, r, e)),
                                        ...
                                        u.setRect(new f.Rect(o.x, Math.min(o.y, i.y), i.x, Math.max(o.y, i.y))),
                                        s.addAnnotation(u),
                                        c.push(u);
                                    case 13:
                                    case 'end':
                                ...
                                function(e) {
                                  for (;;)
                                    switch ((e.prev = e.next)) {
                                      ...
                                      case 10:
                                        return (h = e.sent), (e.next = 13), i.ElementBuilder.create();
                                      case 13:
                                        return (v = e.sent), (e.next = 16), c.getPage(o);
                                      case 16:
                                        return (y = e.sent), (e.next = 19), y.getDefaultMatrix();
                                      case 19:
                                        return (m = e.sent), (e.next = 22), m.mult(s.x, s.y);
                                      case 22:
                                        if (((s = e.sent), void 0 !== (x = u[o]))) {
                                          e.next = 35;
                                          break;
                                        }
                                        return (e.next = 27), c.getPage(o);
                                      case 27:
                                        return (y = e.sent), (b = new i.OCGContext(n)), h.beginOnPage(y, b), (e.next = 32), g(h);
                                      case 32:
                                        (x = e.sent), (u[o] = x), h.end();
                                      case 35:
                                        return (e.next = 37), c.getPage(o);
                                      case 37:
                                        return (y = e.sent), (b = new i.OCGContext(n)), (e.next = 41), d(x, v, c, y, o, s, a);
                                      case 41:
                                        return (e.next = 43), i.SquareAnnot.create(c, i.Rect(10, 200, 800, 300));
                                      case 43:
                                        return (S = e.sent), (e.t0 = S), (e.next = 47), i.ColorPt.init(0, 0, 0);
                                      case 47:
                                        (e.t1 = e.sent), e.t0.setColor.call(e.t0, e.t1, 3), S.refreshAppearance(), y.annotPushBack(S), (e.next = 57);
                                        break;
                                      case 53:
                                        (e.prev = 53), (e.t2 = e.catch(1)), console.log(e.t2.stack);
                                      case 57:
                                      case 'end':
                                        return e.stop();
                                    }
