!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), x = u(m.length), S = 0, w = r ? h(n, x) : a ? h(n, 0) : void 0; x > S; S++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = d(c.length), o = Ft(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
        ...
        kt = function(t, n) {
          return Mt(this, pt.call(Ot(this), t, n));
        },
        Dt = function(t) {
          Ot(this);
        ...
        Ut = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? p(2, t[n]) : V(t, n);
        },
        Bt = function(t, n, r) {
      ...
      v(Gt, Ct),
        h(Gt, yt, Ct.values),
        v(Gt, { slice: kt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (p = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                    if (y % n) throw H('Wrong length!');
                    if ((u = y - p) < 0) throw H('Wrong length!');
                  } else if ((u = d(o) * n) + p > y) throw H('Wrong length!');
                  c = u / n;
                } else (c = g(r)), (i = new K((u = c * n)));
                for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new $(i) }); s < c; ) P(t, s++);
              })),
              (_ = v.prototype = E(Gt)),
              h(_, 'constructor', v))
            : (u(function() {
    ...
    t.exports = function(t, n, r, y, d, g) {
      ...
      if (
        ...
        F ||
          ...
          (S.constructor = b)),
          (O || M) && (_('delete'), _('has'), d && _('get')),
          (M || E) && _(x),
          g && S.clear && delete S.clear;
      } else (b = y.getConstructor(n, t, d, x)), u(b.prototype, r), (c.NEED = !0);
      return h(b, t), (w[t] = b), o(o.G + o.W + o.F * (b != m), w), g || y.setStrong(b, t, d), b;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : S('values'), keys: d ? F : S('keys'), entries: M }), g)) for (b in m) b in E || i(E, b, m[b]);
      ...
      for (
        (t = P(t)) != t || t === w
          ...
          : ((e = O(F(t) / M)),
            ...
            e + f >= a ? ((o = 0), (e = a)) : e + f >= 1 ? ((o = (t * i - 1) * E(2, n)), (e += f)) : ((o = t * E(2, f - 1) * E(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(A) instanceof n && 0 !== O.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && k(t), (t._h = 1)),
                        ...
                        r === n.promise ? f(_('Promise-chain cycle')) : (i = N(r)) ? i.call(r, a, f) : a(r))
                      : f(e);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
      ...
      R = function(t) {
        g.call(a, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                M ? P.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = M || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(a, function() {
          var n;
          M ? P.emit('rejectionHandled', t) : (n = a.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      D = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      q =
        ...
        s(function() {
          ...
          : N,
      K = function(t) {
        var n = (B[t] = E(R.prototype));
        return (n._k = t), n;
      },
      $ =
        H && 'symbol' == e(R.iterator)
          ? function(t) {
              return 'symbol' == e(t);
            }
          : function(t) {
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(B, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: P(0, !1) }))) : (i(t, D) || N(t, D, P(1, {})), (t[D][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (a(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, P(1, r));
            };
          return u && Y && q(V, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var P = String(b[0]), E = f(s(u(b.index), p.length), 0), O = [], F = 1; F < b.length; F++) O.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (h) {
              var A = [P].concat(O, E, p);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(P, p, E, O, M, n);
            E >= w && ((S += p.slice(w, E) + j), (w = E + P.length));
          }
          return S + p.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                P = a(m, v ? p : p.slice(S));
              if (null === P || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === x) S = u(p, S, d);
              else {
                if ((w.push(p.slice(x, S)), w.length === b)) return w;
                for (var E = 1; E <= P.length - 1; E++) if ((w.push(P[E]), w.length === b)) return w;
                S = x = _;
              }
            }
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, p), x[l] || c(x, l, g), (a[g] = p), m)) for (d in e) x[d] || i(x, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
        ...
        return (
          ...
          (_.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: P(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), s;
            },
          }),
          t
        );
  ...
  function(t, n) {
    ...
    !(function(t) {
      t.runEncTest = function() {
        var n = t.PDFNet,
          e = (function() {
            var t,
              e =
                ((t = regeneratorRuntime.mark(function t() {
                  var r, e, o, i, u, c, a, f, s, l, p, h, v, y, d, g, m, b, x, S, w, _, P, E, O;
                        ...
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (
                              ...
                              (t.next = 9),
                              n.PDFDoc.createFromURL(e + 'fish.pdf')
                            );
                          case 9:
                            return (
                              (o = t.sent).initSecurityHandler(),
                              o.lock(),
                          ...
                          case 19:
                            return (i = t.sent), (t.next = 22), i.get('Root');
                          case 22:
                            return (u = t.sent), (t.next = 25), u.value();
                          case 25:
                            return (c = t.sent), (t.next = 28), c.get('Pages');
                          case 28:
                            return (a = t.sent), (t.next = 31), a.value();
                          case 31:
                            return (f = t.sent), (t.next = 34), f.get('Kids');
                          case 34:
                            return (s = t.sent), (t.next = 37), s.value();
                          case 37:
                            return (l = t.sent), (t.next = 40), l.getAt(0);
                          case 40:
                            return (p = t.sent), (t.next = 43), n.Filter.createURLFilter(e + 'my_stream.txt');
                          case 43:
                            return (h = t.sent), (t.next = 46), n.FilterReader.create(h);
                          case 46:
                            return (v = t.sent), (y = new n.Filter('0')), (t.next = 50), n.Filter.createFlateEncode(y);
                          case 50:
                            return (d = t.sent), (t.next = 53), o.createIndirectStreamFromFilter(v, d);
                          case 53:
                            return (g = t.sent), (t.next = 56), p.put('Contents', g);
                          case 56:
                            return (t.next = 58), n.SecurityHandler.createDefault();
                          case 58:
                            return (
                              (m = t.sent).changeUserPasswordUString('test'),
                              console.log("Setting password to 'test'"),
                              m.setPermission(n.SecurityHandler.Permission.e_print, !1),
                              m.setPermission(n.SecurityHandler.Permission.e_extract_content, !0),
                              o.setSecurityHandler(m),
                              console.log('Saving modified file...'),
                              (t.next = 67),
                              o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 67:
                            (b = t.sent), saveBufferAsPDFDoc(b, 'secured.pdf'), (t.next = 76);
                            break;
                          case 71:
                            (t.prev = 71), (t.t0 = t.catch(4)), console.log(t.t0), console.log(t.t0.stack), (r = 1);
                          case 76:
                            return (t.prev = 76), console.log('Running Sample 2'), (x = o), (t.next = 81), x.initSecurityHandler();
                          case 81:
                            if (t.sent) {
                              t.next = 105;
                              break;
                            }
                            (S = !1), console.log("The password has been set to : 'test'"), (w = ['password', 'testy', 'test']), (_ = 0);
                          case 86:
                            if (!(_ < w.length)) {
                              t.next = 101;
                              break;
                            }
                            return (P = w[_]), console.log("Trying password candidate: '" + P + "'"), (t.next = 91), x.initStdSecurityHandlerUString(P);
                          case 91:
                            if (!t.sent) {
                              t.next = 97;
                              break;
                            }
                            return (S = !0), console.log('The password is correct'), t.abrupt('break', 101);
                          case 97:
                          ...
                          case 101:
                            ...
                            return console.log('Document authentication error...'), (r = 1), t.abrupt('return', r);
                          case 105:
                            return x.lock(), console.log('PDF document initialized and locked'), (t.next = 109), x.getSecurityHandler();
                          case 109:
                            return (E = t.sent), (t.t1 = console), (t.next = 113), E.isUserPasswordRequired();
                          case 113:
                            return (t.t2 = t.sent), (t.t3 = 'Document Open Password: ' + t.t2), t.t1.log.call(t.t1, t.t3), (t.t4 = console), (t.next = 119), E.isMasterPasswordRequired();
                          case 119:
                            return (
                              (t.t5 = t.sent),
                              (t.t6 = 'Permissions Password: ' + t.t5),
                              t.t4.log.call(t.t4, t.t6),
                              console.log('Permissions: '),
                              (t.t7 = console),
                              (t.next = 126),
                              E.getPermission(n.SecurityHandler.Permission.e_owner)
                            );
                          case 126:
                            return (
                              (t.t8 = t.sent),
                              (t.t9 = "\tHas 'owner' permissions: " + t.t8),
                              t.t7.log.call(t.t7, t.t9),
                              (t.t10 = console),
                              (t.next = 132),
                              E.getPermission(n.SecurityHandler.Permission.e_doc_open)
                            );
                          case 132:
                            return (
                              (t.t11 = t.sent),
                              (t.t12 = '\tOpen and decrypt the document: ' + t.t11),
                              t.t10.log.call(t.t10, t.t12),
                              (t.t13 = console),
                              (t.next = 138),
                              E.getPermission(n.SecurityHandler.Permission.e_extract_content)
                            );
                          case 138:
                            return (
                              (t.t14 = t.sent),
                              (t.t15 = '\tAllow content extraction: ' + t.t14),
                              t.t13.log.call(t.t13, t.t15),
                              (t.t16 = console),
                              (t.next = 144),
                              E.getPermission(n.SecurityHandler.Permission.e_doc_modify)
                            );
                          case 144:
                            return (
                              (t.t17 = t.sent),
                              (t.t18 = '\tAllow full document editing: ' + t.t17),
                              t.t16.log.call(t.t16, t.t18),
                              (t.t19 = console),
                              (t.next = 150),
                              E.getPermission(n.SecurityHandler.Permission.e_print)
                            );
                          case 150:
                            return (
                              (t.t20 = t.sent),
                              (t.t21 = '\tAllow printing: ' + t.t20),
                              t.t19.log.call(t.t19, t.t21),
                              (t.t22 = console),
                              (t.next = 156),
                              E.getPermission(n.SecurityHandler.Permission.e_print_high)
                            );
                          case 156:
                            return (
                              (t.t23 = t.sent),
                              (t.t24 = '\tAllow high resolution printing: ' + t.t23),
                              t.t22.log.call(t.t22, t.t24),
                              (t.t25 = console),
                              (t.next = 162),
                              E.getPermission(n.SecurityHandler.Permission.e_mod_annot)
                            );
                          case 162:
                            return (
                              (t.t26 = t.sent),
                              (t.t27 = '\tAllow annotation editing: ' + t.t26),
                              t.t25.log.call(t.t25, t.t27),
                              (t.t28 = console),
                              (t.next = 168),
                              E.getPermission(n.SecurityHandler.Permission.e_fill_forms)
                            );
                          case 168:
                            return (
                              (t.t29 = t.sent),
                              (t.t30 = '\tAllow form fill: ' + t.t29),
                              t.t28.log.call(t.t28, t.t30),
                              (t.t31 = console),
                              (t.next = 174),
                              E.getPermission(n.SecurityHandler.Permission.e_access_support)
                            );
                          case 174:
                            return (
                              (t.t32 = t.sent),
                              (t.t33 = '\tAllow content extraction for accessibility: ' + t.t32),
                              t.t31.log.call(t.t31, t.t33),
                              (t.t34 = console),
                              (t.next = 180),
                              E.getPermission(n.SecurityHandler.Permission.e_assemble_doc)
                            );
                          case 180:
                            return (
                              (t.t35 = t.sent),
                              (t.t36 = '\tAllow document assembly: ' + t.t35),
                              t.t34.log.call(t.t34, t.t36),
                              x.removeSecurity(),
                              (t.next = 186),
                              x.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 186:
                            (O = t.sent), saveBufferAsPDFDoc(O, 'not_secured.pdf'), console.log('done'), (t.next = 195);
                            break;
                          case 191:
                            (t.prev = 191), (t.t37 = t.catch(76)), console.log(t.t37.stack), (r = 1);
                          case 195:
