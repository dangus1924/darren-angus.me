    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = {
          ...
          filter: function(t) {
            return Mt(this, H(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          forEach: function(t) {
            X(Ft(this), t, arguments.length > 1 ? arguments[1] : void 0);
          },
          indexOf: function(t) {
      ...
      v(Ut, Dt),
        p(Ut, yt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        jt(Ut, 'buffer', 'b'),
        jt(Ut, 'byteOffset', 'o'),
        jt(Ut, 'byteLength', 'l'),
        jt(Ut, 'length', 'e'),
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
  ...
  function(t, n) {
    !(function(t) {
      var n = t.PDFNet,
        r = t.CoreControls,
        e = function(t, n, e) {
          return r.office2PDFBuffer(t, { l: e }).then(function(t) {
            saveBufferAsPDFDoc(t, n), console.log('Finished downloading ' + n);
          });
        };
      t.runOfficeToPDF = function() {
        n.initialize()
          .then(function() {
            return e('../TestFiles/simple-word_2007.docx', 'converted_docx.pdf');
          })
          .then(function() {
            return e('../TestFiles/simple-powerpoint_2007.pptx', 'converted_pptx.pdf');
          })
          .then(function() {
            return e('../TestFiles/simple-excel_2007.xlsx', 'converted_xlsx.pdf');
          })
          .then(function() {
            console.log('Test Complete!');
          })
          .catch(function(t) {
            console.log('An error was encountered! :(', t);
          });
      };
    })(window);
  },
