!(function(t) {
  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      ...
      v(Gt, Wt),
        h(Gt, yt, Wt.values),
        v(Gt, { slice: Rt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Nt }),
        kt(Gt, 'buffer', 'b'),
        kt(Gt, 'byteOffset', 'o'),
        kt(Gt, 'byteLength', 'l'),
        kt(Gt, 'length', 'e'),
                            ...
                            function(t) {
                              for (;;)
                                switch ((t.prev = t.next)) {
                                  ...
                                  case 13:
                                    return (t.next = 15), n.PDFDoc.createFromURL(r + o);
                                  case 15:
                                    return (p = t.sent).initSecurityHandler(), p.lock(), (t.next = 20), p.getPage(1);
                                  case 20:
                                    if ('0' !== (h = t.sent).id) {
                                      t.next = 24;
                                      break;
                                  ...
                                  case 24:
                                    return (t.next = 26), n.TextExtractor.create();
                                  case 26:
                                    return (v = t.sent), (y = new n.Rect(0, 0, 612, 794)), v.begin(h, y), (t.next = 31), v.getNumLines();
                                  case 31:
                                    if ((t.sent, !c)) {
                                      t.next = 43;
                                      break;
                                    }
                                    return (t.next = 35), v.getWordCount();
                                  case 35:
                                    return (b = t.sent), console.log('Word Count: ' + b), (t.next = 39), v.getAsText();
                                  case 39:
                                  ...
                                  case 49:
                                    ...
                                    return (t.next = 52), v.getFirstLine();
                                  case 52:
                                    d = t.sent;
                                  case 53:
                                    return (t.next = 55), d.isValid();
                                  case 55:
                                    if (!t.sent) {
                                      t.next = 76;
                                      break;
                                    }
                                    return (t.next = 58), d.getFirstWord();
                                  case 58:
                                    x = t.sent;
                                  case 59:
                                    return (t.next = 61), x.isValid();
                                  case 61:
                                    if (!t.sent) {
                                      t.next = 71;
                                      break;
                                    }
                                    return (t.next = 64), x.getString();
                                  case 64:
                                    (g = t.sent), console.log(g);
                                  case 66:
                                    return (t.next = 68), x.getNextWord();
                                  case 68:
                                    (x = t.sent), (t.next = 59);
                                    break;
                                  case 71:
                                    return (t.next = 73), d.getNextLine();
                                  case 73:
                                    (d = t.sent), (t.next = 53);
                                    break;
                                  case 76:
                                  ...
                                  case 77:
                                    ...
                                    return (w = -1), (_ = -1), (t.next = 82), n.ElementBuilder.create();
                                  case 82:
                                    return t.sent, (t.next = 85), n.ElementWriter.create();
                                  case 85:
                                    return t.sent, (t.next = 88), v.getFirstLine();
                                  case 88:
                                    d = t.sent;
                                  case 89:
                                    return (t.next = 91), d.isValid();
                                  case 91:
                                    if (!t.sent) {
                                      t.next = 181;
                                      break;
                                    }
                                    return (t.next = 94), d.getNumWords();
                                  case 94:
                                    if (((t.t0 = t.sent), 0 !== t.t0)) {
                                      t.next = 97;
                                      break;
                                    }
                                    return t.abrupt('continue', 176);
                                  case 97:
                                    return (t.next = 99), d.getFlowID();
                                  case 99:
                                    if (((t.t1 = t.sent), (t.t2 = w), t.t1 === t.t2)) {
                                      t.next = 107;
                                      break;
                                    }
                                    return -1 !== w && (-1 !== _ && ((_ = -1), console.log('</Para>')), console.log('</Flow>')), (t.next = 105), d.getFlowID();
                                  case 105:
                                    (w = t.sent), console.log('<Flow id="' + w + '">');
                                  case 107:
                                    return (t.next = 109), d.getParagraphID();
                                  case 109:
                                    if (((t.t3 = t.sent), (t.t4 = _), t.t3 === t.t4)) {
                                      t.next = 117;
                                      break;
                                    }
                                    return -1 !== _ && console.log('</Para>'), (t.next = 115), d.getParagraphID();
                                  case 115:
                                    (_ = t.sent), console.log('<Para id="' + _ + '">');
                                  case 117:
                                    return (t.next = 119), d.getBBox();
                                  case 119:
                                    return (m = t.sent), (t.next = 122), d.getStyle();
                                  case 122:
                                    return (E = t.sent), (O = '<Line box="' + m.x1 + ', ' + m.y1 + ', ' + m.x2 + ', ' + m.y1 + '">'), (t.t5 = O), (t.next = 127), u(E);
                                  case 127:
                                    return (O = t.t5 += t.sent), (t.next = 130), d.getCurrentNum();
                                  case 130:
                                    return (F = t.sent), (O += ' cur_num="' + F + '">'), console.log(O), (P = ''), (t.next = 136), d.getFirstWord();
                                  case 136:
                                    x = t.sent;
                                  case 137:
                                    return (t.next = 139), x.isValid();
                                  case 139:
                                    if (!t.sent) {
                                      t.next = 175;
                                      break;
                                    }
                                    return (t.next = 142), x.getBBox();
                                  case 142:
                                    return (S = t.sent), (t.next = 145), x.getCurrentNum();
                                  case 145:
                                    return (M = t.sent), (P += '<Word box="' + S.x1 + ', ' + S.y1 + ', ' + S.x2 + ', ' + S.y2 + '" cur_num="' + M + '"'), (t.next = 149), x.getStringLen();
                                  case 149:
                                    if (0 !== t.sent) {
                                      t.next = 152;
                                      break;
                                    }
                                    return t.abrupt('continue', 170);
                                  case 152:
                                    return (t.next = 154), x.getStyle();
                                  case 154:
                                    return (A = t.sent), (t.next = 157), A.compare(E);
                                  case 157:
                                    if (t.sent) {
                                      t.next = 163;
                                      break;
                                    }
                                    return (t.t6 = console), (t.next = 161), u(A);
                                  case 161:
                                    (t.t7 = t.sent), t.t6.log.call(t.t6, t.t7);
                                  case 163:
                                    return (t.t8 = P), (t.next = 166), x.getString();
                                  case 166:
                                    (t.t9 = t.sent), (t.t10 = '>' + t.t9), (P = t.t8 += t.t10 + '</Word>'), console.log(P);
                                  case 170:
                                    return (t.next = 172), x.getNextWord();
                                  case 172:
                                    (x = t.sent), (t.next = 137);
                                    break;
                                  case 175:
                                    console.log('</Line>');
                                  case 176:
                                    return (t.next = 178), d.getNextLine();
                                  case 178:
                                    (d = t.sent), (t.next = 89);
                                    break;
                                  case 181:
                                  ...
                                  case 182:
                                    return console.log('done'), (t.next = 185), n.endDeallocateStack();
                                  case 185:
                                    t.next = 192;
                                    break;
                                  case 187:
                                    (t.prev = 187), (t.t11 = t.catch(10)), console.log(t.t11), console.log(t.t11.stack), 1;
                                  case 192:
                                    if (!l) {
                                      t.next = 269;
                                      break;
                                    }
                                    return 0, (t.prev = 194), (t.next = 197), n.startDeallocateStack();
                                  case 197:
                                    return (t.next = 199), n.PDFDoc.createFromURL(r + o);
                                  case 199:
                                    return (p = t.sent).initSecurityHandler(), p.lock(), (t.next = 204), n.ElementReader.create();
                                  case 204:
                                    return (k = t.sent), (t.next = 207), p.getPageIterator(1);
                                  case 207:
                                    I = t.sent;
                                  case 209:
                                    return (t.next = 211), I.hasNext();
                                  case 211:
                                    if (!t.sent) {
                                      t.next = 222;
                                      break;
                                    }
                                    return (t.next = 214), I.current();
                                  case 214:
                                    return (j = t.sent), k.beginOnPage(j), (t.next = 218), e(k);
                                  case 218:
                                    k.end();
                                  case 219:
                                    I.next(), (t.next = 209);
                                  ...
                                  case 227:
                                    return (t.next = 229), t.sent.current();
                                  case 229:
                                    return (T = t.sent), (t.t12 = i), (t.t13 = T), (t.next = 234), n.Rect.init(27, 392, 563, 534);
                                  case 234:
                                    return (t.t14 = t.sent), (t.t15 = k), (t.next = 238), (0, t.t12)(t.t13, t.t14, t.t15);
                                  case 238:
                                    return (N = t.sent), console.log('Field 1: ' + N), (t.t16 = i), (t.t17 = T), (t.next = 244), n.Rect.init(28, 551, 106, 623);
                                  case 244:
                                    return (t.t18 = t.sent), (t.t19 = k), (t.next = 248), (0, t.t16)(t.t17, t.t18, t.t19);
                                  case 248:
                                    return (N = t.sent), console.log('Field 2: ' + N), (t.t20 = i), (t.t21 = T), (t.next = 254), n.Rect.init(208, 550, 387, 621);
                                  case 254:
                                    return (t.t22 = t.sent), (t.t23 = k), (t.next = 258), (0, t.t20)(t.t21, t.t22, t.t23);
                                  case 258:
                                    return (N = t.sent), console.log('Field 3: ' + N), console.log('Done'), (t.next = 263), n.endDeallocateStack();
                                  case 263:
                                    t.next = 269;
                                    break;
                                  case 265:
                                    (t.prev = 265), (t.t24 = t.catch(194)), console.log(t.t24.stack), 1;
                                  case 269:
                                  case 'end':
                                    return t.stop();
                                }
