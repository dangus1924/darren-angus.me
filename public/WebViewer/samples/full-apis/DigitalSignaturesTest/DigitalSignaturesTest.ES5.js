    ...
    if (r(8)) {
      var o = r(30),
        ...
        Lt = {
          ...
          filter: function(t) {
            return Mt(this, J(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Bt = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? p(2, t[n]) : G(t, n);
        },
        Ut = function(t, n, r) {
      ...
      v(Vt, Ct),
        h(Vt, yt, Ct.values),
        v(Vt, { slice: kt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        jt(Vt, 'buffer', 'b'),
        jt(Vt, 'byteOffset', 'o'),
        jt(Vt, 'byteLength', 'l'),
        jt(Vt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (p = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new $(i) }); s < c; ) F(t, s++);
              })),
              (_ = v.prototype = E(Vt)),
              h(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      R = function(t) {
        g.call(a, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                M ? F.emit('unhandledRejection', o, t) : (r = a.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = a.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = M || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(a, function() {
          var n;
          M ? F.emit('rejectionHandled', t) : (n = a.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      D = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: F(0, !1) }))) : (i(t, D) || N(t, D, F(1, {})), (t[D][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = T(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(G, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (a(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(V, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), q(this, t, F(1, r));
            };
          return u && Y && q(G, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = Z),
      (M.f = nt),
      u && !r(30) && a(G, 'propertyIsEnumerable', Z, !0),
      (y.f = function(t) {
        return X(v(t));
      })),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var F = String(b[0]), E = f(s(u(b.index), p.length), 0), P = [], O = 1; O < b.length; O++) P.push(void 0 === (x = b[O]) ? x : String(x));
            var M = b.groups;
            if (h) {
              var A = [F].concat(P, E, p);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(F, p, E, P, M, n);
            E >= w && ((S += p.slice(w, E) + j), (w = E + F.length));
          }
          return S + p.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                F = a(m, v ? p : p.slice(S));
              if (null === F || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === x) S = u(p, S, d);
              else {
                if ((w.push(p.slice(x, S)), w.length === b)) return w;
                for (var E = 1; E <= F.length - 1; E++) if ((w.push(F[E]), w.length === b)) return w;
                S = x = _;
              }
            }
        ...
        return (
          ...
          (_.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: F(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), s;
            },
          }),
          t
        );
      ...
      t.runDigitalSignaturesTest = function() {
        var n = t.PDFNet,
          r = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var r, e, o, i, u, c, a, f, s, l, p, h, v, y, d, g;
                  ...
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            '../TestFiles/doc_to_sign.pdf',
                            (r = '../TestFiles/pdftron.pfx'),
                            (e = '../TestFiles/signature.jpg'),
                            (o = !0),
                            (t.prev = 4),
                            console.log('Signing PDF document: '),
                            (t.next = 8),
                            n.PDFDoc.createFromURL('../TestFiles/doc_to_sign.pdf')
                          );
                        case 8:
                          return (
                            (i = t.sent).initSecurityHandler(), i.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 14), i.addStdSignatureHandlerFromURL(r, 'password')
                          );
                        case 14:
                          return (u = t.sent), (t.next = 17), i.getField('Signature1');
                        case 17:
                          return (c = t.sent), (t.t0 = n.WidgetAnnot), (t.next = 21), c.getSDFObj();
                        case 21:
                          return (t.t1 = t.sent), (t.next = 24), t.t0.createFromObj.call(t.t0, t.t1);
                        case 24:
                          return (a = t.sent), (t.next = 27), c.useSignatureHandler(u);
                        case 27:
                          return (f = t.sent), (t.next = 30), f.putString('Name', 'PDFTron');
                        case 30:
                          return (t.next = 32), f.putString('Location', 'Vancouver, BC');
                        case 32:
                          return (t.next = 34), f.putString('Reason', 'Document verification.');
                        case 34:
                          return (t.next = 36), n.ElementWriter.create();
                        case 36:
                          return (s = t.sent), (t.next = 39), n.ElementBuilder.create();
                        case 39:
                          return (l = t.sent), s.begin(i), (t.next = 43), n.Image.createFromURL(i, e);
                        case 43:
                          return (p = t.sent), (t.next = 46), p.getImageWidth();
                        case 46:
                          return (h = t.sent), (t.next = 49), p.getImageHeight();
                        case 49:
                          return (v = t.sent), (t.next = 52), l.createImageScaled(p, 0, 0, h, v);
                        case 52:
                          return (y = t.sent), s.writePlacedElement(y), (t.next = 56), s.end();
                        case 56:
                          return (d = t.sent).putRect('BBox', 0, 0, h, v), d.putName('Subtype', 'Form'), d.putName('Type', 'XObject'), s.begin(i), (t.next = 63), l.createFormFromStream(d);
                        case 63:
                          return (y = t.sent), s.writePlacedElement(y), (t.next = 67), s.end();
                        case 67:
                          return (d = t.sent).putRect('BBox', 0, 0, h, v), d.putName('Subtype', 'Form'), d.putName('Type', 'XObject'), (t.next = 73), a.setAppearance(d);
                        case 73:
                          return (t.next = 75), a.refreshAppearance();
                        case 75:
                          return (t.next = 77), i.saveMemoryBuffer(0);
                        case 77:
                          (g = t.sent), saveBufferAsPDFDoc(g, 'signed_doc.pdf'), console.log('Finished signing PDF document'), (t.next = 85);
                          break;
                        case 82:
                          (t.prev = 82), (t.t2 = t.catch(4)), console.log(t.t2);
                        case 85:
          ...
          o = (function() {
            var t = e(
              regeneratorRuntime.mark(function t() {
                var r, e, o, i, u, c, a, f, s, l, p, h, v, y, d;
                return regeneratorRuntime.wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            (r = '../TestFiles/newsletter.pdf'),
                            (e = '../TestFiles/pdftron.pfx'),
                            (o = !0),
                            (t.prev = 3),
                            console.log('Certifying PDF document: "' + r + '"'),
                            (t.next = 7),
                            n.PDFDoc.createFromURL(r)
                          );
                        case 7:
                          return (i = t.sent).initSecurityHandler(), i.lock(), (t.next = 12), i.addStdSignatureHandlerFromURL(e, 'password');
                        case 12:
                          return (u = t.sent), (t.next = 15), i.fieldCreate('Signature1', n.Field.Type.e_signature);
                        case 15:
                          return (c = t.sent), (t.next = 18), i.getPage(1);
                        case 18:
                          return (a = t.sent), (t.t0 = n.WidgetAnnot), (t.next = 22), i.getSDFDoc();
                        case 22:
                          return (t.t1 = t.sent), (t.next = 25), n.Rect.init(0, 0, 0, 0);
                        case 25:
                          return (t.t2 = t.sent), (t.t3 = c), (t.next = 29), t.t0.create.call(t.t0, t.t1, t.t2, t.t3);
                        case 29:
                          return (f = t.sent), a.annotPushBack(f), f.setPage(a), (t.next = 34), f.getSDFObj();
                        case 34:
                          return (s = t.sent).putNumber('F', 132), s.putName('Type', 'Annot'), (t.next = 39), c.useSignatureHandler(u);
                        case 39:
                          return (
                            (l = t.sent).putName('SubFilter', 'adbe.pkcs7.detached'),
                            l.putString('Name', 'PDFTron'),
                            l.putString('Location', 'Vancouver, BC'),
                            l.putString('Reason', 'Document verification'),
                            (t.next = 46),
                            i.getRoot()
                          );
                        case 46:
                          return (p = t.sent), (t.next = 49), p.putDict('Perms');
                        case 49:
                          return t.sent.put('DocMDP', l), (t.next = 53), l.putArray('Reference');
                        case 53:
                          return (h = t.sent), (t.next = 56), h.pushBackDict();
                        case 56:
                          return (v = t.sent).putName('TransformMethod', 'DocMDP'), v.putName('Type', 'SigRef'), (t.next = 61), v.putDict('TransformParams');
                        case 61:
                          return (y = t.sent).putNumber('P', 1), y.putName('Type', 'TransformParams'), y.putName('V', '1.2'), (t.next = 67), i.saveMemoryBuffer(0);
                        case 67:
                          (d = t.sent), saveBufferAsPDFDoc(d, 'newsletter_certified.pdf'), console.log('Finished certifying PDF document.'), (t.next = 75);
                          break;
                        case 72:
                          (t.prev = 72), (t.t4 = t.catch(3)), console.log(t.t4);
                        case 75:
                          return t.abrupt('return', o);
                        case 76:
                        case 'end':
              ...
              regeneratorRuntime.mark(function t() {
                ...
                return regeneratorRuntime.wrap(function(t) {
                  for (;;)
                    switch ((t.prev = t.next)) {
                      case 0:
                        return console.log('Beginning Test'), (n = !0), (t.next = 4), r();
                      case 4:
                        if (t.sent) {
                          t.next = 6;
                          break;
                      ...
                      case 8:
                        ...
                        n = !1;
                      case 10:
                        n ? console.log('Done. All Tests Passed') : console.log('Tests Failed');
                      case 11:
                      case 'end':
                        return t.stop();
                    }
