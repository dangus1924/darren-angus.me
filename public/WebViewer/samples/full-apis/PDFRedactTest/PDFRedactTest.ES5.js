!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Tt = function() {
          return vt.apply(Rt ? ht.call(Pt(this)) : Pt(this), arguments);
        },
        Lt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = m(t, e);
            return new (R(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : m(n, e)) - o));
          },
        },
        kt = function(t, n) {
      ...
      v(Gt, Dt),
        p(Gt, yt, Dt.values),
        v(Gt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      tt = function(t) {
        for (var n, r = R(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = R(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      T.prototype[D] || r(14)(T.prototype, D, T.prototype.valueOf),
      h(T, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
                    ...
                    function(t) {
                      for (;;)
                        switch ((t.prev = t.next)) {
                          case 0:
                            return (t.prev = 2), (t.next = 5), n.PDFDoc.createFromURL('../TestFiles/newsletter.pdf');
                          case 5:
                            return (r = t.sent).initSecurityHandler(), r.lock(), (e = []), (t.t0 = e), (t.t1 = n.Redactor), (t.next = 13), n.Rect.init(100, 100, 550, 600);
                          case 13:
                            return (t.t2 = t.sent), (t.next = 16), t.t1.redactionCreate.call(t.t1, 1, t.t2, !1, 'Top Secret');
                          case 16:
                            return (t.t3 = t.sent), t.t0.push.call(t.t0, t.t3), (t.t4 = e), (t.t5 = n.Redactor), (t.next = 22), n.Rect.init(30, 30, 450, 450);
                          case 22:
                            return (t.t6 = t.sent), (t.next = 25), t.t5.redactionCreate.call(t.t5, 2, t.t6, !0, 'Negative Redaction');
                          case 25:
                            return (t.t7 = t.sent), t.t4.push.call(t.t4, t.t7), (t.t8 = e), (t.t9 = n.Redactor), (t.next = 31), n.Rect.init(0, 0, 100, 100);
                          case 31:
                            return (t.t10 = t.sent), (t.next = 34), t.t9.redactionCreate.call(t.t9, 2, t.t10, !1, 'Positive');
                          case 34:
                            return (t.t11 = t.sent), t.t8.push.call(t.t8, t.t11), (t.t12 = e), (t.t13 = n.Redactor), (t.next = 40), n.Rect.init(100, 100, 200, 200);
                          case 40:
                            return (t.t14 = t.sent), (t.next = 43), t.t13.redactionCreate.call(t.t13, 2, t.t14, !1, 'Positive');
                          case 43:
                            return (t.t15 = t.sent), t.t12.push.call(t.t12, t.t15), (t.t16 = e), (t.t17 = n.Redactor), (t.next = 49), n.Rect.init(300, 300, 400, 400);
                          case 49:
                            return (t.t18 = t.sent), (t.next = 52), t.t17.redactionCreate.call(t.t17, 2, t.t18, !1, '');
                          case 52:
                            return (t.t19 = t.sent), t.t16.push.call(t.t16, t.t19), (t.t20 = e), (t.t21 = n.Redactor), (t.next = 58), n.Rect.init(500, 500, 600, 600);
                          case 58:
                            return (t.t22 = t.sent), (t.next = 61), t.t21.redactionCreate.call(t.t21, 2, t.t22, !1, '');
                          case 61:
                            return (t.t23 = t.sent), t.t20.push.call(t.t20, t.t23), (t.t24 = e), (t.t25 = n.Redactor), (t.next = 67), n.Rect.init(0, 0, 700, 20);
                          case 67:
                            return (t.t26 = t.sent), (t.next = 70), t.t25.redactionCreate.call(t.t25, 3, t.t26, !1, '');
                          case 70:
                            return (t.t27 = t.sent), t.t24.push.call(t.t24, t.t27), (t.next = 74), n.ColorPt.init(0.1, 0.2, 0.6, 0);
                          case 74:
                            return (o = t.sent), (t.next = 77), n.Font.create(r, n.Font.StandardType1Font.e_times_roman);
                          case 77:
                            return (
                              (i = t.sent),
                              (u = { redaction_overlay: !0, positive_overlay_color: o, border: !1, font: i, show_redacted_content_regions: !0 }),
                              n.Redactor.redact(r, e, u, !1, !1),
                              (t.next = 82),
                              r.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized)
                            );
                          case 82:
                            (c = t.sent), saveBufferAsPDFDoc(c, 'redacted.pdf'), console.log('Done...'), (t.next = 91);
                            break;
                          case 87:
                            (t.prev = 87), (t.t28 = t.catch(2)), console.log(t.t28.stack);
                          case 91:
                          case 'end':
                            return t.stop();
                        }
