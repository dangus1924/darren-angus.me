  ...
  function(t, n, e) {
    ...
    if (e(8)) {
      var o = e(30),
        ...
        Wt = function(t, n) {
          return Bt(t, (n = m(n, !0))) ? p(2, t[n]) : U(t, n);
        },
        Gt = function(t, n, e) {
      ...
      mt || ((G.f = Wt), (W.f = Gt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Wt, defineProperty: Gt }),
        u(function() {
          ht.call({});
        }) &&
          (ht = vt = function() {
        ...
        (t.exports = function(t, n, e, r) {
          ...
          m
            ...
            : (u(function() {
              ...
              J(x !== Function.prototype ? P(y).concat(P(x)) : P(y), function(t) {
                t in v || h(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, e) {
    ...
    t.exports = function(t, n, e, v, y, d, g) {
      ...
      if (
        ...
        if (((x = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: M }), g)) for (m in x) m in E || i(E, m, x[m]);
  ...
  function(t, n, e) {
    ...
    if (u.ABV) {
      ...
      (x = function(t) {
        ...
        o && (W(x, 'byteLength', '_l'), W(m, 'buffer', '_b'), W(m, 'byteLength', '_l'), W(m, 'byteOffset', '_o')),
        a(m.prototype, {
          getInt8: function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var b, S = '', w = 0, _ = 0; _ < x.length; _++) {
            m = x[_];
            for (var O = String(m[0]), E = f(s(u(m.index), p.length), 0), F = [], P = 1; P < m.length; P++) F.push(void 0 === (b = m[P]) ? b : String(b));
            var M = m.groups;
            if (h) {
              var A = [O].concat(F, E, p);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(O, p, E, F, M, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var b = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                O = a(x, v ? p : p.slice(S));
              if (null === O || (_ = l(c(x.lastIndex + (v ? 0 : S)), p.length)) === b) S = u(p, S, d);
              else {
                if ((w.push(p.slice(b, S)), w.length === m)) return w;
                for (var E = 1; E <= O.length - 1; E++) if ((w.push(O[E]), w.length === m)) return w;
                S = b = _;
              }
            }
          ...
          c = (function() {
            var t = o(
              regeneratorRuntime.mark(function t() {
                var o, c, a, f, s, l, p, h, v, y, d, g, x, m, b, S, w, _, O, E, F, P, M, A, j;
                return regeneratorRuntime.wrap(
                  function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return console.log('Beginning Test'), 0, (o = null), (t.prev = 3), (t.next = 6), n.PDFDoc.create();
                        case 6:
                          return (o = t.sent).initSecurityHandler(), o.lock(), console.log('PDFNet and PDF document initialized and locked'), (t.next = 12), e(o, 'Image Layer');
                        case 12:
                          return (c = t.sent), (t.next = 15), e(o, 'Text Layer');
                        case 15:
                          return (a = t.sent), (t.next = 18), e(o, 'Vector Layer');
                        case 18:
                          return (f = t.sent), (t.next = 21), o.pageCreate();
                        case 21:
                          return (s = t.sent), (t.next = 24), n.ElementBuilder.create();
                        case 24:
                          return (l = t.sent), (t.next = 27), n.ElementWriter.create();
                        case 27:
                          return (p = t.sent).beginOnPage(s), (t.t0 = r), (t.t1 = o), (t.next = 33), c.getSDFObj();
                        case 33:
                          return (t.t2 = t.sent), (t.next = 36), (0, t.t0)(t.t1, t.t2);
                        case 36:
                          return (h = t.sent), (t.next = 39), l.createFormFromStream(h);
                        case 39:
                          return (v = t.sent), p.writeElement(v), (t.t3 = i), (t.t4 = o), (t.next = 45), f.getSDFObj();
                        case 45:
                          return (t.t5 = t.sent), (t.next = 48), (0, t.t3)(t.t4, t.t5);
                        case 48:
                          return (y = t.sent), (t.next = 51), l.createFormFromStream(y);
                        case 51:
                          (v = t.sent), p.writeElement(v), (t.next = 87);
                          break;
                        case 58:
                          return (t.t7 = t.sent), t.t6.pushBack.call(t.t6, t.t7), (t.t8 = d), (t.next = 63), f.getSDFObj();
                        case 63:
                          return (t.t9 = t.sent), t.t8.pushBack.call(t.t8, t.t9), (t.t10 = d), (t.next = 68), a.getSDFObj();
                        case 68:
                          return (t.t11 = t.sent), t.t10.PushBack.call(t.t10, t.t11), (t.next = 72), n.OCMD.create(o, d, n.OCMD.VisibilityPolicyType.e_AllOn);
                        case 72:
                          return (g = t.sent), (t.t12 = l), (t.t13 = u), (t.t14 = o), (t.next = 78), g.getSDFObj();
                        case 78:
                          return (t.t15 = t.sent), (t.next = 81), (0, t.t13)(t.t14, t.t15);
                        case 81:
                          return (t.t16 = t.sent), (t.next = 84), t.t12.createFormFromStream.call(t.t12, t.t16);
                        case 84:
                          (v = t.sent), (t.next = 99);
                          break;
                        case 87:
                          return (t.t17 = l), (t.t18 = u), (t.t19 = o), (t.next = 92), a.getSDFObj();
                        case 92:
                          return (t.t20 = t.sent), (t.next = 95), (0, t.t18)(t.t19, t.t20);
                        case 95:
                          return (t.t21 = t.sent), (t.next = 98), t.t17.createFormFromStream.call(t.t17, t.t21);
                        case 98:
                          v = t.sent;
                        case 99:
                          return p.writeElement(v), (t.t22 = l), (t.next = 103), s.getPageWidth();
                        case 103:
                          return (t.t23 = t.sent), (t.next = 106), s.getPageHeight();
                        case 106:
                          return (t.t24 = t.sent), (t.next = 109), t.t22.createRect.call(t.t22, 0, 0, t.t23, t.t24);
                        case 109:
                          return (v = t.sent).setPathFill(!1), v.setPathStroke(!0), (t.next = 114), v.getGState();
                        case 114:
                          return t.sent.setLineWidth(40), p.writeElement(v), p.end(), o.pagePushBack(s), (t.next = 121), o.getViewPrefs();
                        case 121:
                          return t.sent.setPageMode(n.PDFDocViewPrefs.PageMode.e_UseOC), (t.next = 125), o.saveMemoryBuffer(n.SDFDoc.SaveOptions.e_linearized);
                        case 125:
                          (x = t.sent), saveBufferAsPDFDoc(x, 'pdf_layers.pdf'), console.log('done example 1'), (t.next = 134);
                          break;
                        case 130:
                          (t.prev = 130), (t.t25 = t.catch(3)), console.log(t.t25.stack), 1;
                        case 134:
                          return (t.prev = 134), (t.next = 137), o.hasOC();
                        case 137:
                          if (t.sent) {
                            t.next = 141;
                            break;
                          }
                          console.log("The document does not contain 'Optional Content'"), (t.next = 197);
                          break;
                        case 141:
                          return (t.next = 143), o.getOCGConfig();
                        case 143:
                          return (m = t.sent), (t.next = 146), n.OCGContext.createFromConfig(m);
                        case 146:
                          return (b = t.sent), (t.next = 149), n.PDFDraw.create();
                        case 149:
                          return (S = t.sent).setImageSize(1e3, 1e3), S.setOCGContext(b), (t.next = 154), o.getPage(1);
                        case 154:
                          return (w = t.sent), (t.next = 157), S.exportStream(w);
                        case 157:
                          return (_ = t.sent), saveBufferAsPNG(_, 'pdf_layers_default.png'), b.setNonOCDrawing(!1), (t.next = 162), o.getOCGs();
                        case 162:
                          if (null === (O = t.sent)) {
                            t.next = 191;
                            break;
                          }
                          return (t.next = 166), O.size();
                        case 166:
                          (F = t.sent), (E = 0);
                        case 168:
                          if (!(E < F)) {
                          ...
                          return (t.t26 = n.OCG), (t.next = 172), O.getAt(E);
                        case 172:
                          return (t.t27 = t.sent), (t.next = 175), t.t26.createFromObj.call(t.t26, t.t27);
                        case 175:
                          return (P = t.sent), b.resetStates(!1), b.setState(P, !0), (M = 'pdf_layers_'), (t.t28 = M), (t.next = 182), P.getName();
                        case 182:
                          return (M = t.t28 += t.sent), (M += '.png'), (t.next = 186), S.exportStream(w);
                        case 186:
                        ...
                        case 188:
                          ...
                          break;
                        case 191:
                          return b.setNonOCDrawing(!0), b.setOCDrawMode(n.OCGContext.OCDrawMode.e_NoOC), (t.next = 195), S.exportStream(w);
                        case 195:
                          (j = t.sent), saveBufferAsPNG(j, 'pdf_layers_non_oc.png');
                        case 197:
                          console.log('done'), (t.next = 204);
                          break;
                        case 200:
                          (t.prev = 200), (t.t29 = t.catch(134)), console.log(t.t29.stack), 1;
                        case 204:
                        case 'end':
                          return t.stop();
                      }
