!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, a),
                  w(r)
                    ? r instanceof $ || 'ArrayBuffer' == (i = x(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
    ...
    z ||
      (f(
        (L = function() {
          ...
          return u && q && J(V, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
  ...
  function(t, n) {
    WebViewer(
      ...
      samplesSetup(t);
      var n = t.annotManager;
      n.setCurrentUser('Justin'),
        n.setIsAdminUser(!0),
        t.openElements(['notesPanel']),
        (document.getElementById('justin').onchange = function() {
          n.setCurrentUser('Justin'), n.setIsAdminUser(!0), t.setReadOnly(!1);
        }),
        (document.getElementById('sally').onchange = function() {
          n.setCurrentUser('Sally'), n.setIsAdminUser(!1), t.setReadOnly(!1);
        }),
        (document.getElementById('brian').onchange = function() {
          n.setCurrentUser('Brian'), n.setIsAdminUser(!1), t.setReadOnly(!0);
        }),
        (document.getElementById('display').onchange = function(t) {
          var r = n.getCurrentUser(),
            e = n.getAnnotationsList().filter(function(t) {
              return t.Listable;
            });
          if (t.target.checked) n.showAnnotations(e);
          else {
