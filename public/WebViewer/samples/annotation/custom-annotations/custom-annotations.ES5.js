!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), x = u(m.length), S = 0, w = r ? p(n, x) : a ? p(n, 0) : void 0; x > S; S++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Tt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = d(c.length), o = Pt(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        jt = function() {
        ...
        Lt = function() {
          return vt.apply(Nt ? ht.call(At(this)) : At(this), arguments);
        },
        Rt = {
          ...
          filter: function(t) {
            return Ft(this, J(At(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
          ...
          subarray: function(t, n) {
            var r = At(this),
              e = r.length,
              o = m(t, e);
            return new (N(r, r[mt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : m(n, e)) - o));
          },
        },
        kt = function(t, n) {
        ...
        Wt = function(t, n) {
          return Bt(t, (n = b(n, !0))) ? h(2, t[n]) : U(t, n);
        },
        Vt = function(t, n, r) {
          return !(Bt(t, (n = b(n, !0))) && w(r) && x(r, 'value')) || x(r, 'get') || x(r, 'set') || r.configurable || (x(r, 'writable') && !r.writable) || (x(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((V.f = Wt), (W.f = Vt)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Wt, defineProperty: Vt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Gt, Dt),
        p(Gt, yt, Dt.values),
        v(Gt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        It(Gt, 'buffer', 'b'),
        It(Gt, 'byteOffset', 'o'),
        It(Gt, 'byteLength', 'l'),
        It(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof X || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? Mt(v, r) : Tt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, f),
                  w(r)
                    ? r instanceof X || 'ArrayBuffer' == (i = S(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      if (i(g)) {
        for (p = c(t.length); p > b; b++) if ((d = n ? m(u((v = t[b]))[0], v[1]) : m(t[b])) === f || d === s) return d;
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        P = A || S(y),
        F = y ? (_ ? S('entries') : P) : void 0,
        M = ('Array' == n && O.entries) || A;
      if (
        (M && (x = s(M.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          A &&
          'values' !== A.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? P : S('values'), keys: d ? P : S('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function j(t, n, r) {
      ...
      for (
        (t = E(t)) != t || t === w
          ...
          : ((e = A(P(t) / F)),
            t * (i = O(2, -e)) < 1 && (e--, (i *= 2)),
            (t += e + f >= 1 ? s / i : s * O(2, 1 - f)) * i >= 2 && (e++, (i /= 2)),
            e + f >= a ? ((o = 0), (e = a)) : e + f >= 1 ? ((o = (t * i - 1) * O(2, n)), (e += f)) : ((o = t * O(2, f - 1) * O(2, n)), (e = 0)));
        n >= 8;
        u[l++] = 255 & o, o /= 256, n -= 8
      );
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[M]._b, a = u + t[T], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      T = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== A.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      j = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      q =
        ...
        s(function() {
          ...
          : j,
      X = function(t) {
        var n = (V[t] = O(L.prototype));
        return (n._k = t), n;
      },
      $ =
        z && 'symbol' == e(L.iterator)
          ? function(t) {
              return 'symbol' == e(t);
            }
          : function(t) {
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || j(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : j(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === U && i(V, t) && !i(G, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== U || !i(V, n) || i(G, n))) {
          var r = T(t, n);
          return !r || !i(V, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
      ...
      (a(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
          return u && H && q(U, t, { configurable: !0, set: n }), X(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            m = s(h);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == m || (p == Array && c(m)))) for (r = new p((n = a(h.length))); n > g; g++) f(r, g, d ? y(h[g], g) : h[g]);
          else for (l = m.call(h), r = new p(); !(o = l.next()).done; g++) f(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), A = [], P = 1; P < b.length; P++) A.push(void 0 === (x = b[P]) ? x : String(x));
            var F = b.groups;
            if (p) {
              var M = [E].concat(A, O, h);
              void 0 !== F && M.push(F);
              var I = String(n.apply(void 0, M));
            } else I = y(E, h, O, A, F, n);
          ...
          'c' == 'abbc'.split(/(b)*/)[1] || 4 != 'test'.split(/(?:)/, -1)[p] || 2 != 'ab'.split(/(?:ab)*/)[p] || 4 != '.'.split(/(.?)(.?)/)[p] || '.'.split(/()()/)[p] > 1 || ''.split(/.?/)[p]
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = f.call(y, o)) && !((u = y.lastIndex) > l && (a.push(o.slice(l, i.index)), i[p] > 1 && i.index < o[p] && h.apply(a, i.slice(1)), (c = i[0][p]), (l = u), a[p] >= v));
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = a(m, v ? h : h.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), h.length)) === x) S = u(h, S, d);
              else {
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, a, f, s, l, h, p) {
      for (var v, y, d = s, g = 0, m = !!h && u(h, p, 3); g < f; ) {
        if (g in a) {
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, h), x[l] || c(x, l, g), (a[g] = h), m)) for (d in e) x[d] || i(x, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    !(function(t) {
      WebViewer(
        { path: '../../../lib', pdftronServer: 'https://demo.pdftron.com/', initialDoc: 'https://pdftron.s3.amazonaws.com/downloads/pl/demo-annotated.pdf' },
        document.getElementById('viewer')
      ).then(function(n) {
        samplesSetup(n);
        var r = window.createStampTool(n),
          e = t.TriangleCreateToolFactory.initialize(n.Annotations, n.Tools),
          o = t.TriangleAnnotationFactory.initialize(n.Annotations);
        n.docViewer.getAnnotationManager().registerAnnotationType(o.prototype.elementName, o);
        var i = function() {
          n.registerTool(
            {
              toolName: 'AnnotationCreateTriangle',
              toolObject: new e(n.docViewer),
              buttonImage:
                '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 7.77L18.39 18H5.61L12 7.77M12 4L2 20h20L12 4z"/><path fill="none" d="M0 0h24v24H0V0z"/></svg>',
            ...
            function(n) {
              return (function(n) {
                return n && n[t.TriangleAnnotationFactory.ANNOT_TYPE] && n[t.TriangleAnnotationFactory.ANNOT_TYPE] === t.TriangleAnnotationFactory.TRIANGLE_ANNOT_ID;
              })(n);
            }
          );
          var r = { type: 'toolButton', toolName: 'AnnotationCreateTriangle' };
          n.setHeaderItems(function(t) {
            t.getHeader('toolbarGroup-Annotate')
              .get('highlightToolGroupButton')
              .insertBefore(r);
          }),
            n.setToolMode('AnnotationCreateTriangle');
        };
        (document.getElementById('custom-stamp').onchange = function(t) {
          t.target.checked
            ? (n.registerTool({
              ...
              n.setHeaderItems(function(t) {
                t.getHeader('toolbarGroup-Annotate')
                  .get('highlightToolGroupButton')
                  .insertBefore({ type: 'toolButton', toolName: 'CustomStampTool' });
              }),
              n.setToolMode('CustomStampTool'))
            : (n.unregisterTool('CustomStampTool'), n.setToolMode('AnnotationEdit'));
        }),
          (document.getElementById('custom-triangle-tool').onchange = function(t) {
            t.target.checked ? i() : (n.unregisterTool('AnnotationCreateTriangle'), n.setToolMode('AnnotationEdit'));
          }),
          (n.iframeWindow.document.body.ondragover = function(t) {
            return t.preventDefault(), !1;
          });
        var u = {};
        n.iframeWindow.document.body.ondrop = function(t) {
          var r = n.docViewer.getScrollViewElement(),
            e = r.scrollLeft || 0,
            o = r.scrollTop || 0;
          return (u = { x: t.pageX + e, y: t.pageY + o }), t.preventDefault(), !1;
        };
        var c = function(t, r, e) {
            ...
            var o = n.Annotations,
              ...
              u = n.annotManager,
              c = i.getDocument(),
              a = i.getDisplayModeManager().getDisplayMode(),
              f = a.getSelectedPages(r, r);
            if (!r.x || null != f.first) {
              var s = null !== f.first ? f.first : i.getCurrentPage(),
                l = c.getPageInfo(s),
                h = a.windowToPage(r, s),
                p = i.getZoom(),
                v = new o.StampAnnotation();
              v.PageNumber = s;
              var y = 90 * i.getCompleteRotation(s);
              (v.Rotation = y),
                270 === y || 90 === y ? ((v.Width = e.height / p), (v.Height = e.width / p)) : ((v.Width = e.width / p), (v.Height = e.height / p)),
                (v.X = (h.x || l.width / 2) - v.Width / 2),
                (v.Y = (h.y || l.height / 2) - v.Height / 2),
                (v.ImageData = t),
                (v.Author = u.getCurrentUser()),
                u.deselectAllAnnotations(),
                u.addAnnotation(v),
                u.redrawAnnotation(v),
                u.selectAnnotation(v);
            }
          },
          a = document.getElementById('sample-image'),
          f = document.createElement('div'),
          s = document.createElement('img');
        (s.id = 'sample-image-copy'), f.appendChild(s), (f.style.position = 'absolute'), (f.style.top = '-500px'), (f.style.left = '-500px'), document.body.appendChild(f);
        var l = a.firstElementChild;
        s.src = l.src;
        var h = l.height;
        (s.onload = function() {
          var t = (h / s.height) * s.width;
          (s.style.width = ''.concat(t, 'px')), (s.style.height = ''.concat(h, 'px'));
          var n = document.createElement('canvas'),
            r = n.getContext('2d');
          (n.width = t), (n.height = h), r.drawImage(s, 0, 0, t, h), (s.src = n.toDataURL());
        }),
          (a.ondragstart = function(t) {
            t.target.style.opacity = 0.5;
            var n = t.target.cloneNode(!0);
            n.id = 'stamp-image-drag-copy';
            var r = document.getElementById('sample-image-copy');
            (n.src = r.src),
              ...
              t.dataTransfer.setDragImage(n, 0.5 * n.width, 0.5 * n.height),
              t.dataTransfer.setData('text', '');
          }),
          (a.ondragend = function(t) {
            var n = document.getElementById('stamp-image-drag-copy');
            c(t.target.src, u, n.getBoundingClientRect()), (t.target.style.opacity = 1), document.body.removeChild(document.getElementById('stamp-image-drag-copy')), t.preventDefault();
          }),
          (a.onclick = function(t) {
            c(t.target.src, {}, document.getElementById('sample-image-copy'));
          }),
          (document.getElementById('file-open').onchange = function(t) {
            var n = new FileReader();
            (n.onload = function() {
              var t = n.result,
                r = new Image();
              (r.onload = function() {
                c(t, {}, { width: 250, height: (r.height / r.width) * 250 });
              }),
                (r.src = t);
            }),
              t.target.files && t.target.files.length > 0 && n.readAsDataURL(t.target.files[0]);
          });
      });
    })(window);
  },
