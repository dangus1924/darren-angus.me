!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Lt = function() {
          return vt.apply(Tt ? ht.call(Ft(this)) : Ft(this), arguments);
        },
        Rt = {
        ...
        kt = function(t, n) {
          return Mt(this, ht.call(Ft(this), t, n));
        },
        Ct = function(t) {
          Ft(this);
        ...
        Ut = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? h(2, t[n]) : B(t, n);
        },
        Vt = function(t, n, r) {
      ...
      bt || ((V.f = Ut), (U.f = Vt)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Ut, defineProperty: Vt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof q || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, a),
                  w(r)
                    ? r instanceof q || 'ArrayBuffer' == (i = S(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === B && i(V, t) && !i(G, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== B || !i(V, n) || i(G, n))) {
          var r = I(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === B, e = T(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(B, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === B && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), X(this, t, E(1, r));
            };
          return u && Y && X(B, t, { configurable: !0, set: n }), q(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), F = [], P = 1; P < b.length; P++) F.push(void 0 === (x = b[P]) ? x : String(x));
            var M = b.groups;
            if (p) {
              var A = [E].concat(F, O, h);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(E, h, O, F, M, n);
  ...
  function(t, n) {
    window.TriangleControlHandleFactory = {
      initialize: function(t) {
        var n = function(t, n) {
          (this.annotation = t), (this.index = n);
        };
        return (
          ((n.prototype = new t.ControlHandle()).getDimensions = function(n, r, e) {
            var o = n.vertices[this.index].x,
              i = n.vertices[this.index].y,
              u = t.ControlHandle.handleWidth / e,
              c = t.ControlHandle.handleHeight / e;
            return (o -= 0.5 * u), (i -= 0.5 * c), new t.Rect(o, i, o + u, i + c);
          }),
          (n.prototype.draw = function(t, n, r, e) {
            var o = this.getDimensions(n, r, e);
            (t.fillStyle = '#FFFFFF'),
              t.beginPath(),
              t.moveTo(o.x1 + o.getWidth() / 2, o.y1),
              t.lineTo(o.x1 + o.getWidth(), o.y1 + o.getHeight()),
              t.lineTo(o.x1, o.y1 + o.getHeight()),
              t.closePath(),
              t.stroke(),
              t.fill();
          }),
          (n.prototype.move = function(n, r, e, o, i) {
            (n.vertices[this.index].x += r), (n.vertices[this.index].y += e);
            for (var u = Number.MAX_VALUE, c = -Number.MAX_VALUE, f = Number.MAX_VALUE, a = -Number.MAX_VALUE, s = 0; s < n.vertices.length; ++s) {
              var l = n.vertices[s];
              (u = Math.min(u, l.x)), (c = Math.max(c, l.x)), (f = Math.min(f, l.y)), (a = Math.max(a, l.y));
            }
            var h = new t.Rect(u, f, c, a);
            return n.setRect(h), !0;
          }),
          n
        );
      },
