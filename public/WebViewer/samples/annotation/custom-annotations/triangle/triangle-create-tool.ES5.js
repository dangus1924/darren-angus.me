!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Gt = function(t, n) {
          return Dt(t, (n = b(n, !0))) ? h(2, t[n]) : B(t, n);
        },
        Ut = function(t, n, r) {
      ...
      bt || ((U.f = Gt), (G.f = Ut)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Gt, defineProperty: Ut }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (m = function(t) {
        ...
        o && (G(m, 'byteLength', '_l'), G(b, 'buffer', '_b'), G(b, 'byteLength', '_l'), G(b, 'byteOffset', '_o')),
        f(b.prototype, {
          getInt8: function(t) {
  ...
  function(t, n, r) {
    ...
    I ||
      ...
      (i = function() {
        var t = new e();
        (this.promise = t), (this.resolve = a(W, t, 1)), (this.reject = a(C, t, 1));
      }),
      (b.f = j = function(t) {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      K = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === B && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
          return u && X && q(B, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      L.prototype[W] || r(14)(L.prototype, W, L.prototype.valueOf),
      h(L, 'Symbol'),
      h(Math, 'Math', !0),
      h(o.JSON, 'JSON', !0);
  },
  ...
  function(t, n) {
    !(function(t) {
      t.TriangleCreateToolFactory = {
        initialize: function(n, r) {
          var e = function(e) {
            r.GenericAnnotationCreateTool.call(this, e, t.TriangleAnnotationFactory.initialize(n));
          };
          return (
            ((e.prototype = new r.GenericAnnotationCreateTool()).mouseMove = function(t) {
              r.GenericAnnotationCreateTool.prototype.mouseMove.call(this, t),
                this.annotation &&
