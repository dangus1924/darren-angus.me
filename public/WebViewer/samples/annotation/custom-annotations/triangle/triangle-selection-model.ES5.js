!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), b = o(g), m = e(c, v, 3), S = u(b.length), x = 0, w = r ? p(n, S) : f ? p(n, 0) : void 0; S > x; x++)
          if ((h || x in b) && ((d = m((y = b[x]), x, g)), t))
            if (r) w[x] = d;
            else if (d)
              switch (t) {
                case 3:
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = {
          ...
          subarray: function(t, n) {
            var r = Pt(this),
              e = r.length,
              o = b(t, e);
            return new (T(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : b(n, e)) - o));
          },
        },
        kt = function(t, n) {
        ...
        Gt = function(t, n) {
          return Wt(t, (n = m(n, !0))) ? h(2, t[n]) : B(t, n);
        },
        Ut = function(t, n, r) {
          return !(Wt(t, (n = m(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? V(t, n, r)
            : ((t[n] = r.value), t);
        };
      mt || ((U.f = Gt), (G.f = Ut)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Gt, defineProperty: Ut }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        jt(Vt, 'buffer', 'b'),
        jt(Vt, 'byteOffset', 'o'),
        jt(Vt, 'byteLength', 'l'),
        jt(Vt, 'length', 'e'),
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof H || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, a),
                  w(r)
                    ? r instanceof H || 'ArrayBuffer' == (i = x(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
              ...
              J(b !== Function.prototype ? F(y).concat(F(b)) : F(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, h) {
      ...
      } else for (y = g.call(t); !(v = y.next()).done; ) if ((d = o(y, b, v.value, n)) === a || d === s) return d;
    }).BREAK = a),
      (n.RETURN = s);
  },
  function(t, n, r) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, y, d, g) {
      ...
      return p(m, t), (w[t] = m), o(o.G + o.W + o.F * (m != b), w), g || y.setStrong(m, t, d), m;
    };
  },
  function(t, n, r) {
    for (
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var b,
        ...
        F = P || x(y),
        M = y ? (_ ? x('entries') : F) : void 0,
        A = ('Array' == n && O.entries) || P;
      if (
        (A && (S = s(A.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((b = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: M }), g)) for (m in b) m in O || i(O, m, b[m]);
        else o(o.P + o.F * (h || E), n, b);
      return b;
    };
  },
  function(t, n, r) {
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (b = function(t) {
        ...
        o && (G(b, 'byteLength', '_l'), G(m, 'buffer', '_b'), G(m, 'byteLength', '_l'), G(m, 'byteOffset', '_o')),
        f(m.prototype, {
          getInt8: function(t) {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (M || 'function' == typeof PromiseRejectionEvent) && t.then(A) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
    ...
    var o = r(1),
      ...
      $ =
        ...
        s(function() {
          ...
          ? function(t, n, r) {
              var e = I(B, n);
              e && delete B[n], N(t, n, r), e && t !== B && N(B, n, e);
            }
          : N,
      H = function(t) {
      ...
      Z = function(t) {
        ...
        return !(this === B && i(U, t) && !i(V, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== B || !i(U, n) || i(V, n))) {
          var r = I(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === B, e = T(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(B, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === B && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
          return u && q && $(B, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = Z),
      (M.f = nt),
      u && !r(30) && f(B, 'propertyIsEnumerable', Z, !0),
      (y.f = function(t) {
        return H(v(t));
      })),
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            b = s(h);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == b || (p == Array && c(b)))) for (r = new p((n = f(h.length))); n > g; g++) a(r, g, d ? y(h[g], g) : h[g]);
          else for (l = b.call(h), r = new p(); !(o = l.next()).done; g++) a(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
    ...
    r(55)('replace', 2, function(t, n, r, v) {
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var E = String(m[0]), O = a(s(u(m.index), h.length), 0), P = [], F = 1; F < m.length; F++) P.push(void 0 === (S = m[F]) ? S : String(S));
            var M = m.groups;
            if (p) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                E = f(b, v ? h : h.slice(x));
              if (null === E || (_ = l(c(b.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
                if ((w.push(h.slice(S, x)), w.length === m)) return w;
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      m = (t.exports = r(58)('WeakMap', g, b, a, !0, !0));
    h &&
      p &&
      (f((e = a.getConstructor(g, 'WeakMap')).prototype, b),
      (c.NEED = !0),
  ...
  function(t, n, r) {
    ...
    t.exports = function t(n, r, f, a, s, l, h, p) {
      for (var v, y, d = s, g = 0, b = !!h && u(h, p, 3); g < a; ) {
        if (g in f) {
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        m = u[g],
        S = m && m.prototype;
      if (S && (S[s] || c(S, s, h), S[l] || c(S, l, g), (f[g] = h), b)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    !(function(t) {
      t.TriangleSelectionModelFactory = {
        initialize: function(n) {
          var r = function(r, e) {
            if ((n.SelectionModel.call(this, r, e), e)) {
              var o = this.getControlHandles(),
                i = t.TriangleControlHandleFactory.initialize(n);
              o.push(new i(r, 0)), o.push(new i(r, 1)), o.push(new i(r, 2));
            }
          };
          return (
            ((r.prototype = new n.SelectionModel()).drawSelectionOutline = function(t, r, e) {
              (t.lineWidth = void 0 !== e ? n.SelectionModel.selectionOutlineThickness / e : n.SelectionModel.selectionOutlineThickness),
                this.canModify() ? (t.strokeStyle = n.SelectionModel.defaultSelectionOutlineColor.toString()) : (t.strokeStyle = n.SelectionModel.defaultNoPermissionSelectionOutlineColor.toString()),
                t.beginPath(),
                t.moveTo(r.vertices[0].x, r.vertices[0].y),
                t.lineTo(r.vertices[1].x, r.vertices[1].y),
                t.lineTo(r.vertices[2].x, r.vertices[2].y),
                t.closePath(),
                t.stroke();
              var o = n.SelectionModel.selectionOutlineDashSize / e,
                i = [o, o];
              t.setLineDash(i), (t.strokeStyle = 'rgb(255, 255, 255)'), t.stroke();
            }),
            (r.prototype.testSelection = function(t, r, e, o) {
              return n.SelectionAlgorithm.canvasVisibilityTest(t, r, e, o);
            }),
            r
          );
        },
