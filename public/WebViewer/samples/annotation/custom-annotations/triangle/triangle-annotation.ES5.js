!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), b = o(g), m = e(c, v, 3), x = u(b.length), S = 0, w = r ? p(n, x) : f ? p(n, 0) : void 0; x > S; S++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = {
          ...
          filter: function(t) {
            return Mt(this, H(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Gt = function(t, n, r) {
          return !(Wt(t, (n = m(n, !0))) && w(r) && x(r, 'value')) || x(r, 'get') || x(r, 'set') || r.configurable || (x(r, 'writable') && !r.writable) || (x(r, 'enumerable') && !r.enumerable)
            ? B(t, n, r)
            : ((t[n] = r.value), t);
        };
      mt || ((G.f = Ut), (U.f = Gt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Ut, defineProperty: Gt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? At(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? F : S('values'), keys: d ? F : S('keys'), entries: M }), g)) for (m in b) m in O || i(O, m, b[m]);
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), X(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(G, t) && !i(B, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(G, n) || i(B, n))) {
          var r = I(t, n);
          return !r || !i(G, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = T(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(V, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), X(this, t, E(1, r));
            };
          return u && q && X(V, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
    ...
    r(55)('replace', 2, function(t, n, r, v) {
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var E = String(m[0]), O = a(s(u(m.index), h.length), 0), P = [], F = 1; F < m.length; F++) P.push(void 0 === (x = m[F]) ? x : String(x));
            var M = m.groups;
            if (p) {
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                E = f(b, v ? h : h.slice(S));
              if (null === E || (_ = l(c(b.lastIndex + (v ? 0 : S)), h.length)) === x) S = u(h, S, d);
              else {
                if ((w.push(h.slice(x, S)), w.length === m)) return w;
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        m = u[g],
        x = m && m.prototype;
      if (x && (x[s] || c(x, s, h), x[l] || c(x, l, g), (f[g] = h), b)) for (d in e) x[d] || i(x, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    !(function(t) {
      t.TriangleAnnotationFactory = {
        initialize: function(n) {
          var r = function() {
            n.MarkupAnnotation.call(this), (this.Subject = 'Triangle'), (this['AnnotType;'] = 'triangle'), (this.vertices = []);
            for (var t = 0; t < 3; ++t) this.vertices.push({ x: 0, y: 0 });
          };
          (r.prototype = new n.MarkupAnnotation()).elementName = 'triangle';
          var e = t.TriangleSelectionModelFactory.initialize(n);
          return (
            (r.prototype.selectionModel = e),
            (r.prototype.draw = function(t, n) {
              this.setStyles(t, n),
                t.beginPath(),
                t.moveTo(this.vertices[0].x, this.vertices[0].y),
                t.lineTo(this.vertices[1].x, this.vertices[1].y),
                t.lineTo(this.vertices[2].x, this.vertices[2].y),
                t.closePath(),
                t.fill(),
                t.stroke();
            }),
            (r.prototype.resize = function(t) {
              ...
              (this.vertices = this.vertices.map(function(t) {
                return (t.x += r), (t.y += e), t;
              })),
                this.setRect(t);
            }),
            (r.prototype.serialize = function(t, r) {
              var e = n.MarkupAnnotation.prototype.serialize.call(this, t, r);
              return e.setAttribute('vertices', n.XfdfUtils.serializePointArray(this.vertices, r)), e;
            }),
            (r.prototype.deserialize = function(t, r) {
              n.MarkupAnnotation.prototype.deserialize.call(this, t, r), (this.vertices = n.XfdfUtils.deserializePointArray(t.getAttribute('vertices'), r));
            }),
            r
          );
        },
        TRIANGLE_ANNOT_ID: 'triangle',
