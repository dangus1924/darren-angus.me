    ...
    if (r(8)) {
      var o = r(30),
        ...
        Lt = {
          ...
          filter: function(t) {
            return At(this, H(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Ut = function(t, n) {
          return Wt(t, (n = m(n, !0))) ? h(2, t[n]) : V(t, n);
        },
        Bt = function(t, n, r) {
      ...
      mt || ((B.f = Ut), (U.f = Bt)),
        c(c.S + c.F * !mt, 'Object', { getOwnPropertyDescriptor: Ut, defineProperty: Bt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Gt, Dt),
        p(Gt, yt, Dt.values),
        v(Gt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Rt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Mt(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              X(b !== Function.prototype ? F(y).concat(F(b)) : F(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: A }), g)) for (m in b) m in O || i(O, m, b[m]);
  ...
  function(t, n, r) {
    ...
    if (u.ABV) {
      ...
      (b = function(t) {
        ...
        o && (U(b, 'byteLength', '_l'), U(m, 'buffer', '_b'), U(m, 'byteLength', '_l'), U(m, 'byteOffset', '_o')),
        f(m.prototype, {
          getInt8: function(t) {
    ...
    var e,
      ...
      I = !!(function() {
        try {
          ...
          return (A || 'function' == typeof PromiseRejectionEvent) && t.then(M) instanceof n && 0 !== P.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
      ...
      R = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                A ? E.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = A || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          A ? E.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      C = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(B, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), J(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        m(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(B, t) && !i(G, t)) && (!(n || !i(this, t) || !i(B, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
      ...
      (f(
        (R = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), J(this, t, E(1, r));
            };
          return u && q && J(V, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
        ...
        (e = [
            ...
            value: function(t, n) {
              switch (t) {
                ...
                case 'onAnnotationCreated':
                  this.annotationsRef.on('child_added', n);
                  break;
                case 'onAnnotationUpdated':
                  this.annotationsRef.on('child_changed', n);
                  break;
                case 'onAnnotationDeleted':
                  this.annotationsRef.on('child_removed', n);
                  break;
                default:
          ...
          },
          {
            ...
            value: function(t, n, r) {
              var e = this;
              this.authorsRef.once('value', function(o) {
                o.hasChild(t)
                  ? e.authorsRef.child(t).once('value', function(t) {
                      n(t.val().authorName);
                    })
                  : r();
              });
          ...
          },
          {
            ...
            value: function() {
              firebase
                ...
                .signInAnonymously()
                .catch(function(t) {
                  'auth/operation-not-allowed' === t.code ? alert('You must enable Anonymous auth in the Firebase Console.') : console.error(t);
                });
            },
          },
          {
            ...
            value: function(t, n) {
              this.annotationsRef.child(t).set(n);
            },
          },
          {
          ...
          },
          {
            ...
            value: function(t) {
              this.annotationsRef.child(t).remove();
            },
          },
          {
            key: 'updateAuthor',
            value: function(t, n) {
              this.authorsRef.child(t).set(n);
            },
          },
        ]) && r(n.prototype, e),
        o && r(n, o),
