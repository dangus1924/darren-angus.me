!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), x = u(m.length), S = 0, w = r ? h(n, x) : f ? h(n, 0) : void 0; x > S; S++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        jt = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = d(c.length), o = At(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Nt = function() {
      ...
      v(Gt, Dt),
        h(Gt, yt, Dt.values),
        v(Gt, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Rt }),
        Mt(Gt, 'buffer', 'b'),
        Mt(Gt, 'byteOffset', 'o'),
        Mt(Gt, 'byteLength', 'l'),
        Mt(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = S(r)) || 'SharedArrayBuffer' == f)) return xt in r ? It(v, r) : jt.call(v, r);
                  (i = r), (p = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              H(m !== Function.prototype ? A(y).concat(A(m)) : A(y), function(t) {
                t in v || h(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
      ...
      if (!h || !v || ('replace' === t && !s) || ('split' === t && !l)) {
        var y = /./[p],
          d = r(u, p, ''[t], function(t, n, r, e, o) {
            return n.exec === f ? (h && !o ? { done: !0, value: y.call(n, r, e) } : { done: !0, value: t.call(r, n, e) }) : { done: !1 };
          }),
          g = d[0],
          m = d[1];
  ...
  function(t, n, r) {
    ...
    ((n = t.exports = function(t, n, r, l, p) {
      ...
      if (i(g)) {
        for (h = c(t.length); h > b; b++) if ((d = n ? m(u((v = t[b]))[0], v[1]) : m(t[b])) === a || d === s) return d;
  ...
  function(t, n, r) {
    for (
      ...
      (e = o[p[l++]]) ? (i(e.prototype, c, !0), i(e.prototype, f, !0)) : (s = !1);
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        A = P || S(y),
        F = y ? (_ ? S('entries') : A) : void 0,
        I = ('Array' == n && O.entries) || P;
      if (
        (I && (x = s(I.call(new t()))) !== Object.prototype && x.next && (a(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? A : S('values'), keys: d ? A : S('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e, o, i) {
      ...
      for (var c = t[I]._b, f = u + t[j], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== P.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
      ...
      R = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                F ? E.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = F || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          F ? E.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      C = function(t) {
        var n = this;
    ...
    j ||
      ((A = function(t) {
        v(this, A, 'Promise', '_h'), h(t), e.call(this);
        try {
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      H = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(U, t) && !i(G, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
      ...
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = T(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(V, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
        (R = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
    ...
    for (var ot = M(v.store), it = 0; ot.length > it; ) d(ot[it++]);
    c(c.S + c.F * !z, 'Symbol', {
      for: function(t) {
    ...
    c(c.S + c.F * ut, 'Object', {
      ...
      R.prototype[D] || r(14)(R.prototype, D, R.prototype.valueOf),
      p(R, 'Symbol'),
      p(Math, 'Math', !0),
      p(o.JSON, 'JSON', !0);
  },
      ...
      'Array',
      {
        from: function(t) {
          var n,
            ...
            g = 0,
            m = s(p);
          if ((d && (y = e(y, v > 2 ? arguments[2] : void 0, 2)), null == m || (h == Array && c(m)))) for (r = new h((n = f(p.length))); n > g; g++) a(r, g, d ? y(p[g], g) : p[g]);
          else for (l = m.call(p), r = new h(); !(o = l.next()).done; g++) a(r, g, d ? u(l, y, [o.value, g], !0) : o.value);
          return (r.length = g), r;
        },
      }
    );
  ...
  function(t, n, r) {
    ...
    if (
      ...
      (!v ||
        r(2)(function() {
          return (h[r(5)('match')] = !1), a(p) != p || a(h) == h || '/a/i' != a(p, 'i');
        }))
    ) {
      a = function(t, n) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), p.length), 0), P = [], A = 1; A < b.length; A++) P.push(void 0 === (x = b[A]) ? x : String(x));
            var F = b.groups;
            if (h) {
              var I = [E].concat(P, O, p);
              void 0 !== F && I.push(F);
              var M = String(n.apply(void 0, I));
            } else M = y(E, p, O, P, F, n);
            O >= w && ((S += p.slice(w, O) + M), (w = O + E.length));
          }
          return S + p.slice(w);
        },
      ];
          ...
          'c' == 'abbc'.split(/(b)*/)[1] || 4 != 'test'.split(/(?:)/, -1)[h] || 2 != 'ab'.split(/(?:ab)*/)[h] || 4 != '.'.split(/(.?)(.?)/)[h] || '.'.split(/()()/)[h] > 1 || ''.split(/.?/)[h]
            ? function(t, n) {
                ...
                for (
                  ...
                  (i = a.call(y, o)) && !((u = y.lastIndex) > l && (f.push(o.slice(l, i.index)), i[h] > 1 && i.index < o[h] && p.apply(f, i.slice(1)), (c = i[0][h]), (l = u), f[h] >= v));
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < p.length; ) {
              ...
              var _,
                E = f(m, v ? p : p.slice(S));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : S)), p.length)) === x) S = u(p, S, d);
              else {
      ...
      e(
        ...
        'ArrayBuffer',
        {
          slice: function(t, n) {
            ...
            for (var r = u(this).byteLength, e = c(t, r), o = c(void 0 === n ? r : n, r), i = new (l(this, p))(f(o - e)), a = new h(this), s = new h(i), v = 0; e < o; )
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        x = b && b.prototype;
      if (x && (x[s] || c(x, s, p), x[l] || c(x, l, g), (f[g] = p), m)) for (d in e) x[d] || i(x, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n, r) {
    var e = r(85),
      ...
      f = function t(n, r, f) {
        ...
        for (a in (h && (f = r), f))
          ((s = !p && x && void 0 !== x[a]) && c(m, a)) ||
            ((l = s ? x[a] : f[a]),
            (m[a] =
              h && 'function' != typeof x[a]
                ? f[a]
                : d && s
                ? i(l, e)
                : g && x[a] == l
  ...
  function(t, n) {
    ...
    WebViewer(
      ...
      var n = t.docViewer,
        ...
        u = document.getElementById('copy');
      t.openElements(['notesPanel']);
      var c = !1;
      if ('http://localhost:3000' === window.location.origin) {
        var f = new XMLHttpRequest();
        (f.onreadystatechange = function() {
          4 === f.readyState && 200 === f.status && (i.value = 'http://'.concat(f.responseText, ':3000/samples/annotation/realtime-collaboration/'));
        }),
          f.open('GET', '/ip', !0),
          f.send();
      } else (i.value = 'https://pdftron.com/samples/web/samples/annotation/realtime-collaboration/'), (i.value = 'https://pdfjs.express/samples/annotation/realtime-collaboration/');
      (u.onclick = function() {
        i.select(), document.execCommand('copy'), document.getSelection().empty();
      }),
        n.on('documentLoaded', function() {
          var t = null,
                  ...
                  return regeneratorRuntime.wrap(function(t) {
                    for (;;)
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (t.next = 2), r.importAnnotCommand(n.val().xfdf);
                        case 2:
                          if (((e = t.sent), !(o = e[0]))) {
                            t.next = 9;
                            break;
                          }
                          return (t.next = 7), o.resourcesLoaded();
                        case 7:
                          (o.authorId = n.val().authorId), r.redrawAnnotation(o);
                        case 9:
                        case 'end':
                          return t.stop();
                      }
            ...
            u = function(t) {
              var n = '<delete><id>'.concat(t.key, '</id></delete>');
              r.importAnnotCommand(n);
            },
            f = function(t) {
              c || (r.setCurrentUser(t), window.alert('Welcome back '.concat(t)), (c = !0));
            },
            a = function() {
              var n,
                e = window.prompt('Welcome! Tell us your name :)');
              e && ((n = e), r.setCurrentUser(n), o.updateAuthor(t, { authorName: n }));
            };
          o.bind('onAuthStateChanged', function(r) {
            r ? ((t = r.uid), o.checkAuthor(t, f, a), o.bind('onAnnotationCreated', n), o.bind('onAnnotationUpdated', i), o.bind('onAnnotationDeleted', u)) : o.signInAnonymously();
          }),
            r.on(
              'annotationChanged',
              (function() {
                var n = e(
                  regeneratorRuntime.mark(function n(e, i, u) {
                    var c;
                    return regeneratorRuntime.wrap(function(n) {
                      for (;;)
                        switch ((n.prev = n.next)) {
                          ...
                          case 2:
                            return (n.next = 4), r.exportAnnotCommand();
                          case 4:
                            (c = n.sent),
                              e.forEach(function(n) {
                                var e = null;
                                'add' === i
                                  ? (n.InReplyTo && (e = r.getAnnotationById(n.InReplyTo).authorId || 'default'),
                                    t && (n.authorId = t),
                                    o.createAnnotation(n.Id, { authorId: t, parentAuthorId: e, xfdf: c }))
                                  : 'modify' === i
                                  ? (n.InReplyTo && (e = r.getAnnotationById(n.InReplyTo).authorId || 'default'), o.updateAnnotation(n.Id, { authorId: t, parentAuthorId: e, xfdf: c }))
                                  : 'delete' === i && o.deleteAnnotation(n.Id);
                              });
                          case 6:
                          case 'end':
                            return n.stop();
            ...
            r.setPermissionCheckCallback(function(n, r) {
              return r.authorId === t;
            });
        });
    });
