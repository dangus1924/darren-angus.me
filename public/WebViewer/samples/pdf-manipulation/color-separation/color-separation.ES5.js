!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n) {
      ...
      return function(n, c, v) {
        for (var y, d, g = i(n), m = o(g), b = e(c, v, 3), S = u(m.length), x = 0, w = r ? h(n, S) : f ? h(n, 0) : void 0; S > x; x++)
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Rt = {
          ...
          filter: function(t) {
            return Ft(this, X(Pt(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        Bt = function(t, n) {
          return Wt(t, (n = b(n, !0))) ? p(2, t[n]) : U(t, n);
        },
        Vt = function(t, n, r) {
      ...
      v(Gt, Dt),
        h(Gt, yt, Dt.values),
        v(Gt, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Lt }),
        jt(Gt, 'buffer', 'b'),
        jt(Gt, 'byteOffset', 'o'),
        jt(Gt, 'byteLength', 'l'),
        jt(Gt, 'length', 'e'),
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        M = P || x(y),
        F = y ? (_ ? x('entries') : M) : void 0,
        A = ('Array' == n && O.entries) || P;
      if (
        (A && (S = s(A.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : x('values'), keys: d ? M : x('keys'), entries: F }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    if (u.ABV) {
      ...
      (m = function(t) {
        ...
        (b = function(t, n, r) {
          ...
          if (o + (r = void 0 === r ? e - o : p(r)) > e) throw x('Wrong length!');
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = T(r ? G : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(U, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(G, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
          return u && q && $(U, t, { configurable: !0, set: n }), H(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), p.length), 0), P = [], M = 1; M < b.length; M++) P.push(void 0 === (S = b[M]) ? S : String(S));
            var F = b.groups;
            if (h) {
              var A = [E].concat(P, O, p);
              void 0 !== F && A.push(F);
              var j = String(n.apply(void 0, A));
            } else j = y(E, p, O, P, F, n);
            O >= w && ((x += p.slice(w, O) + j), (w = O + E.length));
          }
          return x + p.slice(w);
        },
      ];
      ...
      return (
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < p.length; ) {
              m.lastIndex = v ? x : 0;
              var _,
                E = f(m, v ? p : p.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : x)), p.length)) === S) x = u(p, x, d);
              else {
                if ((w.push(p.slice(S, x)), w.length === b)) return w;
  ...
  function(t, n, r) {
    for (
      ...
      var d,
        ...
        b = u[g],
        S = b && b.prototype;
      if (S && (S[s] || c(S, s, p), S[l] || c(S, l, g), (f[g] = p), m)) for (d in e) S[d] || i(S, d, e[d], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n, r) {
    var e = r(85),
      ...
      f = function t(n, r, f) {
        ...
        for (a in (h && (f = r), f))
          ((s = !p && S && void 0 !== S[a]) && c(m, a)) ||
            ((l = s ? S[a] : f[a]),
            (m[a] =
              h && 'function' != typeof S[a]
                ? f[a]
                : d && s
                ? i(l, e)
                : g && S[a] == l
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', fullAPI: !0, initialDoc: '../../../samples/files/op-blend-test.pdf' }, document.getElementById('viewer')).then(function(t) {
      samplesSetup(t);
      var n = t.docViewer,
        r = document.getElementById('colors'),
        e = !1;
      n.on('documentLoaded', function() {
        var o = n.getDocument();
        (e = !1),
          o.enableColorSeparations(!0),
          t.openElements(['loadingModal']),
          o.on('colorSeparationAdded', function(i) {
            e = !0;
            var u = document.createElement('input');
            (u.id = i.name),
              (u.type = 'checkbox'),
              (u.checked = i.enabled),
              (u.onchange = function(r) {
                t.openElements(['loadingModal']), o.enableSeparation(i.name, r.target.checked), n.refreshAll(), n.updateView();
              });
            var c = document.createElement('label');
            (c.id = ''.concat(i.name, ' label')), (c.htmlFor = i.name), (c.style.color = 'rgb('.concat(i.rgb.join(','), ')')), (c.innerHTML = i.name);
            var f = document.createElement('br');
            r.appendChild(u), r.appendChild(c), r.appendChild(f), t.closeElements(['loadingModal']);
          });
      }),
        n.on('mouseMove', function(t) {
          var r = n.getToolMode().getMouseLocation(t),
            e = n.getDisplayModeManager().getDisplayMode(),
            o = e.getSelectedPages(r, r).first;
          if (null !== o) {
            var i = e.windowToPage(r, o);
            if (i)
              for (var u = i.pageNumber, c = i.x, f = i.y, a = n.getColorSeparationsAtPoint(u, c, f), s = 0; s < a.length; ++s)
                document.getElementById(''.concat(a[s].name, ' label')).innerHTML = ''.concat(a[s].name, ' ').concat(a[s].value, '%');
          }
        }),
        n.on('pageComplete', function() {
          e && t.closeElements(['loadingModal']);
        });
    });
  },
]);
