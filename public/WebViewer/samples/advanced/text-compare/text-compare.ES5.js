!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        jt = function(t) {
          ...
          for (l && a > 2 && (f = s(f, arguments[2], 2)), n = 0, r = y(c.length), o = Mt(this, r); r > n; n++) o[n] = l ? f(c[n], n) : c[n];
          return o;
        },
        Tt = function() {
        ...
        Wt = function(t, n) {
          return Bt(t, (n = b(n, !0))) ? p(2, t[n]) : G(t, n);
        },
        Vt = function(t, n, r) {
      ...
      v(Ut, Dt),
        h(Ut, dt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: Lt }),
        At(Ut, 'buffer', 'b'),
        At(Ut, 'byteOffset', 'o'),
        At(Ut, 'byteLength', 'l'),
        At(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  p = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = S(r)) || 'SharedArrayBuffer' == a)) return xt in r ? It(v, r) : jt.call(v, r);
                  (i = r), (p = Pt(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              J(m !== Function.prototype ? M(d).concat(M(m)) : M(d), function(t) {
                t in v || h(v, t, d[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      var m,
        ...
        M = O || S(d),
        F = d ? (_ ? S('entries') : M) : void 0,
        I = ('Array' == n && P.entries) || O;
      if (
        (I && (x = s(I.call(new t()))) !== Object.prototype && x.next && (f(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          O &&
          'values' !== O.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : S('values'), keys: y ? M : S('keys'), entries: F }), g)) for (b in m) b in P || i(P, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function U(t, n, r, e, o, i) {
      var u = h(+r);
      if (u + n > t[A]) throw S('Wrong index!');
      for (var c = t[I]._b, a = u + t[j], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var e,
      ...
      j = !!(function() {
        try {
          ...
          return (F || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== O.indexOf('6.6') && -1 === S.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      T = function(t) {
        var n;
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && k(t), (t._h = 1)),
                        ...
                        r === n.promise ? f(_('Promise-chain cycle')) : (i = T(r)) ? i.call(r, a, f) : a(r))
                      : f(e);
                  } catch (t) {
                    s && !u && s.exit(), f(t);
                  }
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(V, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), Y(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(V, t) && !i(U, t)) && (!(n || !i(this, t) || !i(V, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(V, n) || i(U, n))) {
          var r = j(t, n);
      ...
      nt = function(t) {
        for (var n, r = t === G, e = N(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    z ||
      (a(
        (L = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), Y(this, t, E(1, r));
            };
          return u && q && Y(G, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), P = f(s(u(b.index), p.length), 0), O = [], M = 1; M < b.length; M++) O.push(void 0 === (x = b[M]) ? x : String(x));
            var F = b.groups;
            if (h) {
              var I = [E].concat(O, P, p);
              void 0 !== F && I.push(F);
              var A = String(n.apply(void 0, I));
            } else A = d(E, p, P, O, F, n);
  ...
  function(t, n) {
    ...
    var u,
      c = [
        { initialDoc: '../../files/text-compare_1.pdf', domElement: 'leftPanel', diffPanel: 'compareLeftPanel', instance: null, loaded: !1 },
        { initialDoc: '../../files/text-compare_2.pdf', domElement: 'rightPanel', diffPanel: 'compareRightPanel', instance: null, loaded: !1 },
      ];
    CoreControls.setWorkerPath('../../../lib/core'),
      CoreControls.getDefaultBackendType().then(
        (function() {
          var t = i(
              ...
              return regeneratorRuntime.wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (u = CoreControls.initPDFWorkerTransports(n, {})), (t.next = 3), Promise.all([f(c[0]), f(c[1])]);
                    case 3:
                      (e = t.sent), (o = r(e, 2)), (i = o[0]), (s = o[1]), i.docViewer.on('documentLoaded', a), s.docViewer.on('documentLoaded', a), a();
                    case 10:
                    case 'end':
                      return t.stop();
                  }
    ...
    var a = function() {
      ...
      f = function(t) {
        return new Promise(function(n) {
          WebViewer({ path: '../../../lib', workerTransportPromise: { pdf: u }, initialDoc: t.initialDoc }, document.getElementById(''.concat(t.domElement))).then(function(r) {
            var e = r.docViewer,
              o = r.CoreControls;
            (t.instance = r),
              r.disableTools(),
              r.closeElement('toolsHeader'),
              e.on(
                'documentLoaded',
                i(
                    ...
                    return regeneratorRuntime.wrap(function(i) {
                      for (;;)
                        switch ((i.prev = i.next)) {
                          case 0:
                            (t.loaded = !0), e.getDisplayModeManager().setDisplayMode(new o.DisplayMode(e, o.DisplayModes.Single)), r.setFitMode(r.FitMode.FitWidth), n(r);
                          case 5:
                          case 'end':
                            return i.stop();
                        }
              ...
              e.on('pageNumberUpdated', function(t) {
                var n = c[0].instance === r ? c[1].instance : c[0].instance;
                n.docViewer.getCurrentPage() !== t && n.setCurrentPageNumber(t), l(t);
              }),
              e.on('zoomUpdated', function(n) {
                -1 === document.getElementById(t.domElement).className.indexOf('hidden') && p(n, t.domElement);
              }),
              (document.getElementById(''.concat(t.domElement, '-select')).onchange = function(t) {
                r.loadDocument(t.target.value);
              }),
              (document.getElementById(''.concat(t.domElement, '-file-picker')).onchange = function(t) {
                var n = t.target.files[0];
                n && r.loadDocument(n);
              }),
              (document.getElementById(''.concat(t.domElement, '-url-form')).onsubmit = function(n) {
                n.preventDefault(), r.loadDocument(document.getElementById(''.concat(t.domElement, '-url')).value);
              });
          });
        });
      },
      s = function(t, n) {
        var r = t.docViewer.getDocument();
        return new Promise(function(t) {
          r.loadPageText(n, function(n) {
            t(n);
          });
        });
      },
          ...
          regeneratorRuntime.mark(function t(n) {
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), s(c[0].instance, n);
                  case 2:
                    return (r = t.sent), (t.next = 5), s(c[1].instance, n);
                  case 5:
                    for (
                      e = t.sent, document.querySelector('#'.concat(c[0].diffPanel)).innerHTML = '', document.querySelector('#'.concat(c[1].diffPanel)).innerHTML = '', o = Diff.diffLines(r, e), i = 0;
                      i < o.length;
                      i++
                    )
                      (u = o[i]).removed || u.added
                        ? (function() {
                            var t = '';
                            i + 1 < o.length && (o[i + 1].removed || o[i + 1].added) && ((t = o[i + 1].value), i++);
                            var n = Diff.diffChars(u.value, t),
                              r = '',
                              e = '';
                            n.forEach(function(t) {
                              var n = t.value.replace(/\r?\n/g, '<br />');
                              if (t.removed || t.added) {
                                if (!t.value.replace(/\s/g, '').length) return;
                                t.added ? (e = ''.concat(e, '<span class="added">').concat(n, '</span>')) : t.removed && (r = ''.concat(r, '<span class="removed">').concat(n, '</span>'));
                              } else (r += n), (e += n);
                            });
                            var a = document.createElement('div');
                            a.className = 'section empty';
                            var f = document.createElement('div');
                            f.className = 'section removed';
                            var s = document.createElement('p');
                            (s.innerHTML = r), f.appendChild(s), document.querySelector('#'.concat(c[0].diffPanel)).appendChild(f);
                            var l = document.createElement('p');
                            (l.innerHTML = e), a.appendChild(l), document.querySelector('#'.concat(c[1].diffPanel)).appendChild(a);
                            var p = Math.max(a.scrollHeight, f.scrollHeight);
                            (a.style.height = ''.concat(p, 'px')), (f.style.height = ''.concat(p, 'px'));
                          })()
                        : (function() {
                            var t = document.createElement('div'),
                              n = document.createElement('div');
                            (t.className = 'section identical'), (n.className = 'section identical');
                            ...
                            var a = !1,
                              f = function() {
                                (a = !a), (i.className = a ? '' : 'hidden'), (o.className = a ? '' : 'hidden'), (e.className = a ? 'hidden' : ''), (r.className = a ? 'hidden' : '');
                              };
                            n.addEventListener('click', f),
                              t.addEventListener('click', f),
                              document.querySelector('#'.concat(c[0].diffPanel)).appendChild(t),
                              document.querySelector('#'.concat(c[1].diffPanel)).appendChild(n);
                          })();
                  case 10:
                  case 'end':
                    return t.stop();
      ...
      p = function(t, n) {
        c.forEach(function(r) {
          var e = r.instance;
          e.getZoomLevel() !== t && n !== r.domElement && e.setZoomLevel(t);
        });
      },
      h = 0;
    (window.onresize = function() {
      c[0].instance && c[0].instance.docViewer && l(c[0].instance.docViewer.getCurrentPage());
    }),
      ...
      (document.getElementById('toggleLeft').onclick = function(t) {
        (t.target.disabled = !0),
          (document.getElementById('toggleRight').disabled = !1),
          document.getElementById('rightPanel').classList.add('hidden'),
          document.getElementById('leftPanel').classList.remove('hidden');
      }),
      (document.getElementById('toggleRight').onclick = function(t) {
        (t.target.disabled = !0),
          (document.getElementById('toggleLeft').disabled = !1),
