!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      bt || ((G.f = Bt), (B.f = Gt)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Bt, defineProperty: Gt }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Ut, Ct),
        p(Ut, yt, Ct.values),
        v(Ut, { slice: kt, set: Dt, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        It(Ut, 'buffer', 'b'),
        It(Ut, 'byteOffset', 'o'),
        It(Ut, 'byteLength', 'l'),
        It(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? At(v, r) : jt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
                ...
                for (p(t, '_d', { b: i, o: h, l: u, e: c, v: new J(i) }); s < c; ) E(t, s++);
              })),
              (_ = v.prototype = O(Ut)),
              p(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((m = { values: _ ? F : x('values'), keys: d ? F : x('keys'), entries: M }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function G(t, n, r, e) {
      var o = p(+r);
      if (o + n > t[I]) throw x('Wrong index!');
      var i = t[A]._b,
        u = o + t[j],
        c = i.slice(u, u + n);
    ...
    function U(t, n, r, e, o, i) {
      var u = p(+r);
      if (u + n > t[I]) throw x('Wrong index!');
      for (var c = t[A]._b, f = u + t[j], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), $(t, n, r)) : N(t, n, r)
        );
      },
      H = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === V && i(G, t) && !i(U, t)) && (!(n || !i(this, t) || !i(G, t) || (i(this, D) && this[D][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== V || !i(G, n) || i(U, n))) {
          var r = j(t, n);
          return !r || !i(G, n) || (i(t, D) && t[D][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = T(w(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == D || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === V, e = T(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(V, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, D) && i(this[D], t) && (this[D][t] = !1), $(this, t, E(1, r));
            };
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), P = [], F = 1; F < b.length; F++) P.push(void 0 === (S = b[F]) ? S : String(S));
            var M = b.groups;
            if (p) {
              var A = [E].concat(P, O, h);
              void 0 !== M && A.push(M);
              var I = String(n.apply(void 0, A));
            } else I = y(E, h, O, P, M, n);
            O >= w && ((x += h.slice(w, O) + I), (w = O + E.length));
          }
          return x + h.slice(w);
        },
      ];
  ...
  function(t, n) {
    WebViewer({ path: '../../../lib', initialDoc: 'https://s3.amazonaws.com/pdftron/downloads/pl/legal-contract.pdf', fullAPI: !0, enableRedaction: !0 }, document.getElementById('viewer')).then(
      function(t) {
        samplesSetup(t),
          (document.getElementById('select').onchange = function(n) {
            t.loadDocument(n.target.value);
          }),
          (document.getElementById('file-picker').onchange = function(n) {
            var r = n.target.files[0];
            r && t.loadDocument(r);
          }),
          (document.getElementById('url-form').onsubmit = function(n) {
            n.preventDefault(), t.loadDocument(document.getElementById('url').value);
          }),
