!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (A && (x = s(A.call(new t()))) !== Object.prototype && x.next && (a(x, w, !0), e || 'function' == typeof x[l] || u(x, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
    ...
    var o = r(1),
      ...
      X = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || N(t, C, E(1, {})), (t[C][n] = !0)), H(t, n, r)) : N(t, n, r)
        );
      },
      J = function(t, n) {
        b(t);
      ...
      (f(
        (L = function() {
          ...
          var t = h(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === V && n.call(U, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), H(this, t, E(1, r));
            };
          return u && q && H(V, t, { configurable: !0, set: n }), $(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), p.length), 0), P = [], F = 1; F < b.length; F++) P.push(void 0 === (x = b[F]) ? x : String(x));
            var M = b.groups;
            if (h) {
              var A = [E].concat(P, O, p);
              void 0 !== M && A.push(M);
              var j = String(n.apply(void 0, A));
            } else j = y(E, p, O, P, M, n);
            O >= w && ((S += p.slice(w, O) + j), (w = O + E.length));
          }
          return S + p.slice(w);
        },
      ];
  ...
  function(t, n) {
    ...
    WebViewer({ path: '../../../lib', preloadWorker: 'all' }, r).then(function(t) {
      samplesSetup(t);
      var n = document.getElementById('documents');
      ['../../../samples/files/demo.pdf', '../../../samples/full-apis/TestFiles/simple-excel_2007.xlsx', '../../../samples/full-apis/TestFiles/simple-word_2007.docx'].forEach(function(e) {
        var o = document.createElement('div');
        o.innerHTML = e.split('/').slice(-1)[0];
        var i = document.createElement('button');
        i.innerHTML = 'Loading';
        var u = document.createElement('li');
        u.appendChild(o), u.appendChild(i), n.appendChild(u);
        ...
        c.open('GET', e, !0),
          ...
          (c.onload = function() {
            ...
            200 === this.status &&
              ((i.onclick = function() {
                (r.style.visibility = 'visible'), t.loadDocument(n, { filename: e.split('/').slice(-1)[0] });
              }),
              (i.innerHTML = 'Open'));
          }),
          c.send();
        ...
        document.getElementById('toggle').addEventListener('click', function() {
          'hidden' === r.style.visibility ? (r.style.visibility = 'visible') : (r.style.visibility = 'hidden');
        });
    });
  },
]);
