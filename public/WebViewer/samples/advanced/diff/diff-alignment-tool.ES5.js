!(function(t) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        It = function(t) {
          ...
          for (l && f > 2 && (a = s(a, arguments[2], 2)), n = 0, r = d(c.length), o = Mt(this, r); r > n; n++) o[n] = l ? a(c[n], n) : c[n];
          return o;
        },
        Tt = function() {
        ...
        Rt = {
          copyWithin: function(t, n) {
            return V.call(At(this), t, n, arguments.length > 2 ? arguments[2] : void 0);
          },
          every: function(t) {
          ...
          filter: function(t) {
            return Pt(this, X(At(this), t, arguments.length > 1 ? arguments[1] : void 0));
          },
          find: function(t) {
        ...
        kt = function(t, n) {
          return Pt(this, ht.call(At(this), t, n));
        },
        Ct = function(t) {
          At(this);
        ...
        Wt = function(t, n) {
          return Vt(t, (n = b(n, !0))) ? h(2, t[n]) : G(t, n);
        },
        Ut = function(t, n, r) {
          return !(Vt(t, (n = b(n, !0))) && w(r) && S(r, 'value')) || S(r, 'get') || S(r, 'set') || r.configurable || (S(r, 'writable') && !r.writable) || (S(r, 'enumerable') && !r.enumerable)
            ? B(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((U.f = Wt), (W.f = Ut)),
        c(c.S + c.F * !bt, 'Object', { getOwnPropertyDescriptor: Wt, defineProperty: Ut }),
        u(function() {
          pt.call({});
        }) &&
          (pt = vt = function() {
      ...
      v(Bt, Dt),
        p(Bt, yt, Dt.values),
        v(Bt, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Lt }),
        jt(Bt, 'buffer', 'b'),
        jt(Bt, 'byteOffset', 'o'),
        jt(Bt, 'byteLength', 'l'),
        jt(Bt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Ft(v, r) : It.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              ((v = r(function(t, r, e, o) {
                ...
                return (
                  l(t, v, a),
                  w(r)
                    ? r instanceof K || 'ArrayBuffer' == (i = x(r)) || 'SharedArrayBuffer' == i
                      ? void 0 !== o
                        ? new y(r, Ot(e, n), o)
                        : void 0 !== e
                        ? new y(r, Ot(e, n))
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        M = A || x(y),
        P = y ? (_ ? x('entries') : M) : void 0,
        F = ('Array' == n && O.entries) || A;
      if (
        (F && (S = s(F.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          A &&
          'values' !== A.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? M : x('values'), keys: d ? M : x('keys'), entries: P }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    function B(t, n, r, e, o, i) {
      ...
      for (var c = t[F]._b, f = u + t[I], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
  ...
  function(t, n, r) {
    ...
    var e,
                  ...
                  try {
                    c
                      ? (o || (2 == t._h && k(t), (t._h = 1)),
                        ...
                        r === n.promise ? a(_('Promise-chain cycle')) : (i = T(r)) ? i.call(r, f, a) : f(r))
                      : a(e);
                  } catch (t) {
                    s && !u && s.exit(), a(t);
                  }
      ...
      L = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = S(function() {
                P ? E.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = P || R(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          P ? E.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      C = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || T(t, C, E(1, {})), (t[C][n] = !0)), $(t, n, r)) : T(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      Z = function(t) {
        ...
        return !(this === G && i(U, t) && !i(B, t)) && (!(n || !i(this, t) || !i(U, t) || (i(this, C) && this[C][t])) || n);
      },
      Q = function(t, n) {
        if (((t = w(t)), (n = _(n, !0)), t !== G || !i(U, n) || i(B, n))) {
          var r = I(t, n);
          return !r || !i(U, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = N(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == C || n == a || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = N(r ? B : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(G, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (f(
        (L = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === G && n.call(B, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), $(this, t, E(1, r));
            };
          return u && q && $(G, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      (r(45).f = Z),
      (P.f = nt),
      u && !r(30) && f(G, 'propertyIsEnumerable', Z, !0),
      (y.f = function(t) {
        return K(v(t));
      })),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = a(s(u(b.index), h.length), 0), A = [], M = 1; M < b.length; M++) A.push(void 0 === (S = b[M]) ? S : String(S));
            var P = b.groups;
            if (p) {
              var F = [E].concat(A, O, h);
              void 0 !== P && F.push(P);
              var j = String(n.apply(void 0, F));
            } else j = y(E, h, O, A, P, n);
            O >= w && ((x += h.slice(w, O) + j), (w = O + E.length));
          }
          return x + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                E = f(m, v ? h : h.slice(x));
              if (null === E || (_ = l(c(m.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
  ...
  function(t, n) {
    !(function(t) {
      var n,
        ...
        o = !1,
        i = function(t) {
          n && r && t(n.Start, n.End, r.Start, r.End, n.PageNumber - 1, r.PageNumber - 1);
        },
        u = function(t, e, i, u, c) {
          o
            ? ((o = !1),
              (i.textContent = 'Enter Alignment Mode'),
              t.setToolMode('AnnotationEdit'),
              e.setToolMode('AnnotationEdit'),
              t.docViewer.getAnnotationManager().deleteAnnotations(t.docViewer.getAnnotationManager().getAnnotationsList(), !0, !0),
              e.docViewer.getAnnotationManager().deleteAnnotations(e.docViewer.getAnnotationManager().getAnnotationsList(), !0, !0),
              (n = void 0),
              (r = void 0),
              c && c())
            : ((o = !0), (i.textContent = 'Leave Alignment Mode'), t.setToolMode('AnnotationCreateArrow'), e.setToolMode('AnnotationCreateArrow'), u && u());
        };
      t.DiffAlignmentTool = {
        initializeDiffAlignmentToolHandlers: function(t, c, f, a, s) {
          (n = void 0), (r = void 0);
          var l = document.getElementById('toggle-alignment-mode');
          o && u(t, c, l, a, s),
            e ||
              ((e = !0),
              t.docViewer.getTool('AnnotationCreateArrow').on('annotationAdded', function(r) {
                n && t.docViewer.getAnnotationManager().deleteAnnotation(n, !1, !0), (r.ReadOnly = !0), (n = r), i(f);
              }),
              c.docViewer.getTool('AnnotationCreateArrow').on('annotationAdded', function(t) {
                r && c.docViewer.getAnnotationManager().deleteAnnotation(r, !1, !0), (t.ReadOnly = !0), (r = t), i(f);
              }),
              l.addEventListener('click', function() {
                u(t, c, l, a, s);
              }),
              document.getElementById('enable-snap-mode').addEventListener('change', function(n) {
                var r = n.target.checked;
                t.docViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? t.docViewer.SnapMode.DEFAULT : null),
                  c.docViewer.getTool('AnnotationCreateArrow').setSnapMode(r ? c.docViewer.SnapMode.DEFAULT : null);
              }));
        },
        isInAlignmentMode: function() {
          return o;
        },
      };
    })(window);
